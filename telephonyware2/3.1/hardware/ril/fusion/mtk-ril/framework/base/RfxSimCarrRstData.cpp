...
RfxSimCarrRstData::RfxSimCarrRstData(void *_data, int _length) : RfxBaseData(_data, _length) {
    if (_data != NULL) {
        ...
        if (pCarrRst->allowed_carriers != NULL) {
            allowedCarriers = (RIL_Carrier *)calloc(pData->len_allowed_carriers,
                    sizeof(RIL_Carrier));
        ...
        if (pCarrRst->excluded_carriers != NULL) {
            excludedCarriers = (RIL_Carrier *)calloc(pData->len_excluded_carriers,
                    sizeof(RIL_Carrier));
