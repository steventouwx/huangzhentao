...
#ifndef __SIM_PHONEBOOK_UTILS_H_
#define __SIM_PHONEBOOK_UTILS_H_
...
class SimPhonebookUtils {

public:
    virtual ~SimPhonebookUtils();
...
public:
    ...
    static int transferSpecialAlpaToReal(char * src, char *dest, int maxLen);
    static int buildAdnAnrNumber(char * src, char *dest, int maxLen);
    static int hexCharToInt(char c);
    static char* getPhbStorageString(int type);
...
#endif /* __SIM_PHONEBOOK_UTILS_H_ */
