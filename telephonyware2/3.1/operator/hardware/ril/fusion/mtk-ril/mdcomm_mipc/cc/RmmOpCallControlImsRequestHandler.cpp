...
#include "RmmOpCallControlImsRequestHandler.h"
#include "RmmOpCallControlInterface.h"
...
RFX_IMPLEMENT_OP_HANDLER_CLASS(RmmOpCallControlImsRequestHandler, RIL_CMD_PROXY_2);

RmmOpCallControlImsRequestHandler::RmmOpCallControlImsRequestHandler(int slot_id,
        int channel_id):RmmCallControlBaseHandler(slot_id, channel_id){
    registerToHandleRequest(requests, sizeof(requests)/sizeof(int));
}

RmmOpCallControlImsRequestHandler::~RmmOpCallControlImsRequestHandler() {
}

void RmmOpCallControlImsRequestHandler::onHandleTimer() {
}

void RmmOpCallControlImsRequestHandler::onHandleRequest(const sp<RfxMclMessage>& msg) {
...
void RmmOpCallControlImsRequestHandler::requestDialFrom(const sp<RfxMclMessage>& msg) {
...
void RmmOpCallControlImsRequestHandler::setEmergencyCallConfig(const sp<RfxMclMessage>& msg) {
...
void RmmOpCallControlImsRequestHandler::deviceSwitch(const sp<RfxMclMessage>& msg) {
...
void RmmOpCallControlImsRequestHandler::cancelDeviceSwitch(const sp<RfxMclMessage>& msg) {
    /* +ECT=<type>
