 ...
 */
#ifndef __RTM_SMS_HEADER_H__
#define __RTM_SMS_HEADER_H__
...
/*****************************************************************************
 * Class RtmSmsUserDataHeader
 *****************************************************************************/
class RtmSmsUserDataHeader {
// Constructor/Destructor
public:
    // Construct user data header with UDH array.
    RtmSmsUserDataHeader(
