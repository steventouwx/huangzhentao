...
public:
    ...
    void enqueueResponseMessage(RILD_RadioTechnology_Group source, int slotId, int token, int error,
            Parcel *parcel);
    void enqueueUrcMessage(RILD_RadioTechnology_Group source, int slotId, int urcId, Parcel *parcel);
...
private:
    ...
    static sp<RfxDispatchThread> s_self;
