 ...
 * Include
 *****************************************************************************/
#include "RtmPhbInModemController.h"
...
#define RFX_LOG_TAG "RtmPhbInModem"

using ::android::String8;

/*****************************************************************************
 * Class RtmPhbInModemController
 *****************************************************************************/

RFX_IMPLEMENT_CLASS("RtmPhbInModemController", RtmPhbInModemController, RfxController);
...
RtmPhbInModemController::RtmPhbInModemController() {
...
void RtmPhbInModemController::onInit() {
...
bool RtmPhbInModemController::onCheckIfRejectMessage(const sp<RfxMessage>& message,
...
bool RtmPhbInModemController::onHandleUrc(const sp<RfxMessage>& message) {
    int msgId = message->getId();
...
void RtmPhbInModemController::createNewReadSimPhonebookMessageToRmc(
...
bool RtmPhbInModemController::onHandleResponse(const sp<RfxMessage>& message) {
    int msgId = message->getId();
    switch (msgId) {
...
int RtmPhbInModemController::beginToReadSimPhoneBookRecordsFromModem(void) {
    int ret = 1;
    readedAdnRecords = 0;
...
bool RtmPhbInModemController::onHandleRequest(const sp<RfxMessage>& message) {
    int msgId = message->getId();
    switch (msgId) {
