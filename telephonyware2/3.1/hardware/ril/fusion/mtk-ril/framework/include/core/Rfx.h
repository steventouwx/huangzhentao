...
extern void mipcIndicationCallback(mipc_msg_t *msg_ptr, void* priv_ptr);
...
extern void rfx_update_connection_state(RIL_SOCKET_ID socketId, int isConnected, unsigned int clientType);
#ifdef __cplusplus
}  // extern "C"
#endif
