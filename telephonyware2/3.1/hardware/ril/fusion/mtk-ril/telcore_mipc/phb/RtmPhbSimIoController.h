...
#ifndef __RTM_PHB_SIMIO_CONTROLLER_H__
#define __RTM_PHB_SIMIO_CONTROLLER_H__
 ...
 * Class RfxController
 *****************************************************************************/
class RtmPhbSimIoController : public RfxController {
    // Required: declare this class
    RFX_DECLARE_CLASS(RtmPhbSimIoController);

public:
    RtmPhbSimIoController();
    virtual ~RtmPhbSimIoController();
...
#endif /* __RTM_PHB_SIMIO_CONTROLLER_H__ */
