...
#define MAX_CCMNI_INTERFACE_COUNT 16
...
#define NETWORK_INTERFACE_XFRM "xfrm"
...
typedef enum {
    ...
    SINGLE_BEARER_ONLY_ALLOWED_ACTIVATE_FAILED = 3
} PDN_REASON;
...
typedef enum {
    PDN_CHANGE_REASON_NORMAL = 0,
    PDN_CHANGE_REASON_HANDOVER = 1,
} PDN_CHANGE_REASON;
