...
#ifndef __RTM_VT_CONTROLLER_H__
#define __RTM_VT_CONTROLLER_H__
...
class RtmVtController : public RfxController {
    RFX_DECLARE_CLASS(RtmVtController);  // Required: declare this class

public:
    RtmVtController();

    virtual ~RtmVtController();
