...
enum {
    ...
    SIM_IMPI,
    SIM_IMPI_PUK,
    /** Network subset service provider, top 7 digits of IMSI and GID1 */
    SIM_NS_SP,
    SIM_NS_SP_PUK,
    /** MTK added: IMSI + GID1 +GID2 **/
    SIM_SIM_C,
    SIM_SIM_C_PUK,
}PERSO_SUB_STATE;

/**
 * cat available values in +ESMLCK
 */
enum {
...
enum {
    ...
    SML_CARRIER_ATT_RSU,
    SML_CARRIER_TFN_RSU,
    SML_CARRIER_KDDI_RSU,
    SML_CARRIER_RJIO_RSU,
