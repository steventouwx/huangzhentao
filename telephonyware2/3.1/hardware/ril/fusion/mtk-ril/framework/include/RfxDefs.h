...
// when enable RFX_OBJ_DEBUG, need to enable libladder in fusion/mtk-ril/Android.mk
...
typedef enum {
    ...
    CME_415_UNSUPPORTED_MEDIA_TYPE = 415,
    CME_500_INTERNAL_SERVER_ERROR = 500,
    CME_503_SERVICE_UNAVAILABLE = 503,
    /// @}
...
// Hold call error, no call exist
#define RIL_E_ERROR_IMS_CONTROL_CALL_FAILED_CALL_IS_NOT_EXIST RIL_E_OEM_ERROR_25
