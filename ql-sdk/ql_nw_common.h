...
#ifndef __QL_NW_COMMON_H__
#define __QL_NW_COMMON_H__
...
#define QL_NW_RAT_DEYN_REASON_MAX_V01 8

/**<  the signal strength level*/
typedef enum QL_NW_SIGNAL_STRENGTH_LEVEL_ENUM
{
    QL_NW_SIGNAL_STRENGTH_LEVEL_MIN             = -1,
    QL_NW_SIGNAL_STRENGTH_LEVEL_NONE            = 0,  /**<  No signal*/
    QL_NW_SIGNAL_STRENGTH_LEVEL_POOR            = 1,  /**<  Poor signal*/
    QL_NW_SIGNAL_STRENGTH_LEVEL_MODERATE        = 2,  /**<  Moderate signal*/
    QL_NW_SIGNAL_STRENGTH_LEVEL_GOOD            = 3,  /**<  Good signal*/
    QL_NW_SIGNAL_STRENGTH_LEVEL_GREAT           = 4,  /**<  Great signal*/
...
{
    QL_NW_NETWORK_STATUS_NONE            = 0,    /**<  Unknown network status. */
    QL_NW_NETWORK_STATUS_CURRENT_SERVING = 1,    /**<  The serving network. */
    QL_NW_NETWORK_STATUS_PREFERRED       = 2,    /**<  Preferred network. */
    QL_NW_NETWORK_STATUS_NOT_PREFERRED   = 3,    /**<  Non-preferred network. */
    QL_NW_NETWORK_STATUS_AVAILABLE       = 4,    /**<  Available network. */
    QL_NW_NETWORK_STATUS_FORBIDDEN       = 5     /**<  Forbidden network. */
...
{
    QL_NW_TECH_DOMAIN_NONE    = 0,    /**<  Unknown technical specification. */
...
typedef enum QL_NW_DENY_REASON_TYPE_ENUM
{
    ...
    QL_NW_PEI_NOT_ACCEPTED_DENY_REASON                                      = 5, /**<  PEI not accepted */
    QL_NW_ILLEGAL_ME_DENY_REASON                                            = 6, /**<  Illegal ME */
    QL_NW_EPS_SERVICES_NOT_ALLOWED_DENY_REASON                              = 7, /**<  EPS services not allowed */
    QL_NW_5GS_SERVICES_NOT_ALLOWED_DENY_REASON                              = 7, /**<  5GS services not allowed */
    ...
    QL_NW_NON_5GS_AUTHENTICATION_UNCACCEPTABLE_DENY_REASON                  = 26, /**<  Non-5GS authentication unacceptable */
    QL_NW_N1_MODE_NOT_ALLOWED_DENY_REASON                                   = 27, /**<  N1 mode not allowed */
    QL_NW_RESTRICTED_SERVICE_AREA_DENY_REASON                               = 28, /**<  restricted service area */
    QL_NW_REDIRECTION_TO_EPC_REQUIRED_DENY_REASON                           = 31, /**<  redirection to epc required */
    ...
    QL_NW_LADN_NOT_AVAILABLE_DENY_REASON                                    = 43, /**<  LADN not available */
    QL_NW_NO_NETWORK_SLICES_AVAILABLE_DENY_REASON                           = 62, /**<  No network slices available */
    QL_NW_MAX_NUMBER_OF_PDU_SESSIONS_REACHED_DENY_REASON                    = 65, /**<  Max number of PDU sessions reached */
    QL_NW_INSUFFICIENT_RESOURCES_FOR_SPECIFIC_SLICE_AND_DNN_DENY_REASON     = 67, /**<  Insufficient resources for specific slice and dnn */
    QL_NW_INSUFFICIENT_RESOURCES_FOR_SPECIFIC_SLICE_DENY_REASON             = 69, /**<  Insufficient resources for specific slice */
    QL_NW_NGKSI_ALREADY_IN_USE_DENY_REASON                                  = 71, /**<  NGKSI already in use */
    QL_NW_NON_3GPP_ACCESS_TO_5GCN_NOT_ALLOWED_DENY_REASON                   = 72, /**<  Non 3gpp access to 5GCN not allowed */
    QL_NW_SERVICE_NETWORK_NOT_AUTHORIZED_DENY_REASON                        = 73, /**<  Service network not authorized */
    QL_NW_TEMPORARILY_NOT_AUTHORIZED_FOR_THIS_SNPN_DENY_REASON              = 74, /**<  Temporarily not authorized for this snpn */
    QL_NW_PERMANENTLY_NOT_AUTHORIZED_FOR_THIS_SNPN_DENY_REASON              = 75, /**<  Permanently not authorized for this snpn */
    QL_NW_NOT_AUTHORIZED_FOR_THIS_CAG_OR_AUTHORIZED_FOR_CAG_CELLS_ONLY_DENY_REASON = 76, /**<  Not authorized for this CAG or authorized for CAG cells only */
    QL_NW_WIRELINE_ACCESS_AREA_NOT_ALLOWED_DENY_REASON                      = 77, /**<  WIRELINE access area not allowed */
    QL_NW_PAYLOAD_WAS_NOT_FORWARDED_DENY_REASON                             = 90, /**<  Payload was not forwarded */
    QL_NW_DNN_NOT_SUPPORTED_WITH_NO_SLICE_OR_IN_SPECIFIC_SLICE_DENY_REASON  = 91, /**<  DNN not supported with no slice or in specific slice */
    QL_NW_INSUFFUCIENT_USERPLANE_RESOURCES_FOR_PDU_SESS_DENY_REASON         = 92, /**<  Insuffucient userplane resources for pdu sess */
    ...
    QL_NW_PROTOCAL_ERROR_DENY_REASON                                        = 111, /**<  Protocol error, unspecified. */
}QL_NW_DENY_REASON_TYPE_E;


/**<  RF BAND INFO*/
typedef enum QL_NW_BAND_INFO_ENUM
{
    QL_NW_ACTIVE_BAND_CDMA_0_V01 = 0, 
    QL_NW_ACTIVE_BAND_CDMA_1_V01 = 1, 
    QL_NW_ACTIVE_BAND_CDMA_3_V01 = 3, 
    QL_NW_ACTIVE_BAND_CDMA_4_V01 = 4, 
    QL_NW_ACTIVE_BAND_CDMA_5_V01 = 5, 
    QL_NW_ACTIVE_BAND_CDMA_6_V01 = 6, 
    QL_NW_ACTIVE_BAND_CDMA_7_V01 = 7, 
    QL_NW_ACTIVE_BAND_CDMA_8_V01 = 8, 
    QL_NW_ACTIVE_BAND_CDMA_9_V01 = 9, 
    QL_NW_ACTIVE_BAND_CDMA_10_V01 = 10, 
    QL_NW_ACTIVE_BAND_CDMA_11_V01 = 11, 
    QL_NW_ACTIVE_BAND_CDMA_12_V01 = 12, 
    QL_NW_ACTIVE_BAND_CDMA_13_V01 = 13, 
    QL_NW_ACTIVE_BAND_CDMA_14_V01 = 14, 
    QL_NW_ACTIVE_BAND_CDMA_15_V01 = 15, 
    QL_NW_ACTIVE_BAND_CDMA_16_V01 = 16, 
    QL_NW_ACTIVE_BAND_CDMA_17_V01 = 17, 
    QL_NW_ACTIVE_BAND_CDMA_18_V01 = 18, 
    QL_NW_ACTIVE_BAND_CDMA_19_V01 = 19, 
    QL_NW_ACTIVE_BAND_GSM_450_V01 = 40, 
    QL_NW_ACTIVE_BAND_GSM_480_V01 = 41, 
    QL_NW_ACTIVE_BAND_GSM_750_V01 = 42, 
    QL_NW_ACTIVE_BAND_GSM_850_V01 = 43, 
    QL_NW_ACTIVE_BAND_GSM_900_EXTENDED_V01 = 44, 
    QL_NW_ACTIVE_BAND_GSM_900_PRIMARY_V01 = 45, 
    QL_NW_ACTIVE_BAND_GSM_900_RAILWAYS_V01 = 46, 
    QL_NW_ACTIVE_BAND_GSM_1800_V01 = 47, 
    QL_NW_ACTIVE_BAND_GSM_1900_V01 = 48, 
    QL_NW_ACTIVE_BAND_WCDMA_2100_V01 = 80, 
    QL_NW_ACTIVE_BAND_WCDMA_PCS_1900_V01 = 81, 
    QL_NW_ACTIVE_BAND_WCDMA_DCS_1800_V01 = 82, 
    QL_NW_ACTIVE_BAND_WCDMA_1700_US_V01 = 83, 
    QL_NW_ACTIVE_BAND_WCDMA_850_V01 = 84, 
    QL_NW_ACTIVE_BAND_WCDMA_800_V01 = 85, 
    QL_NW_ACTIVE_BAND_WCDMA_2600_V01 = 86, 
    QL_NW_ACTIVE_BAND_WCDMA_900_V01 = 87, 
    QL_NW_ACTIVE_BAND_WCDMA_1700_JAPAN_V01 = 88, 
    QL_NW_ACTIVE_BAND_WCDMA_1500_JAPAN_V01 = 90, 
    QL_NW_ACTIVE_BAND_WCDMA_850_JAPAN_V01 = 91, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_1_V01 = 120, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_2_V01 = 121, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_3_V01 = 122, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_4_V01 = 123, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_5_V01 = 124, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_6_V01 = 125, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_7_V01 = 126, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_8_V01 = 127, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_9_V01 = 128, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_10_V01 = 129, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_11_V01 = 130, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_12_V01 = 131, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_13_V01 = 132, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_14_V01 = 133, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_17_V01 = 134, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_33_V01 = 135, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_34_V01 = 136, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_35_V01 = 137, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_36_V01 = 138, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_37_V01 = 139, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_38_V01 = 140, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_39_V01 = 141, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_40_V01 = 142, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_18_V01 = 143, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_19_V01 = 144, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_20_V01 = 145, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_21_V01 = 146, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_24_V01 = 147, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_25_V01 = 148, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_41_V01 = 149, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_42_V01 = 150, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_43_V01 = 151, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_23_V01 = 152, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_26_V01 = 153, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_32_V01 = 154, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_125_V01 = 155, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_126_V01 = 156, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_127_V01 = 157, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_28_V01 = 158, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_29_V01 = 159, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_30_V01 = 160, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_66_V01 = 161, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_250_V01 = 162, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_46_V01 = 163, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_27_V01 = 164, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_31_V01 = 165, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_71_V01 = 166, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_47_V01 = 167, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_48_V01 = 168, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_67_V01 = 169, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_68_V01 = 170, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_49_V01 = 171, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_85_V01 = 172, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_72_V01 = 173, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_73_V01 = 174, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_86_V01 = 175, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_53_V01 = 176, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_87_V01 = 177, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_88_V01 = 178, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_70_V01 = 179, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_44_V01 = 180, 
    QL_NW_ACTIVE_BAND_LTE_OPERATING_BAND_256_V01 = 181, 
    QL_NW_ACTIVE_BAND_TDSCDMA_BAND_A_V01 = 200, 
    QL_NW_ACTIVE_BAND_TDSCDMA_BAND_B_V01 = 201, 
    QL_NW_ACTIVE_BAND_TDSCDMA_BAND_C_V01 = 202, 
    QL_NW_ACTIVE_BAND_TDSCDMA_BAND_D_V01 = 203, 
    QL_NW_ACTIVE_BAND_TDSCDMA_BAND_E_V01 = 204, 
    QL_NW_ACTIVE_BAND_TDSCDMA_BAND_F_V01 = 205, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_1_V01 = 250, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_2_V01 = 251, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_3_V01 = 252, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_5_V01 = 253, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_7_V01 = 254, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_8_V01 = 255, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_20_V01 = 256, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_28_V01 = 257, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_38_V01 = 258, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_41_V01 = 259, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_50_V01 = 260, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_51_V01 = 261, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_66_V01 = 262, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_70_V01 = 263, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_71_V01 = 264, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_74_V01 = 265, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_75_V01 = 266, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_76_V01 = 267, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_77_V01 = 268, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_78_V01 = 269, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_79_V01 = 270, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_80_V01 = 271, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_81_V01 = 272, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_82_V01 = 273, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_83_V01 = 274, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_84_V01 = 275, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_85_V01 = 276, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_257_V01 = 277, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_258_V01 = 278, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_259_V01 = 279, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_260_V01 = 280, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_261_V01 = 281, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_12_V01 = 282, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_25_V01 = 283, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_34_V01 = 284, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_39_V01 = 285, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_40_V01 = 286, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_65_V01 = 287, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_86_V01 = 288, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_48_V01 = 289, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_14_V01 = 290, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_13_V01 = 291, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_18_V01 = 292, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_26_V01 = 293, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_30_V01 = 294, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_29_V01 = 295, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_53_V01 = 296, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_46_V01 = 297, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_91_V01 = 298, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_92_V01 = 299, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_93_V01 = 300, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_94_V01 = 301, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_96_V01 = 302, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_106_V01 = 303, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_67_V01 = 304, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_68_V01 = 305, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_89_V01 = 306, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_95_V01 = 307, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_97_V01 = 308, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_98_V01 = 309, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_99_V01 = 310, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_104_V01 = 311, 
    QL_NW_ACTIVE_BAND_NR5G_BAND_47_V01 = 312
}QL_NW_BAND_INFO_E;
...
{
    QL_NW_SERVICE_NONE    = 0,  /**<  No service. */
    QL_NW_SERVICE_LIMITED = 1,  /**<  Restricted service. */
    QL_NW_SERVICE_FULL    = 2,  /**<  Normal service. */
...
{
    QL_NW_CELL_ACCESS_NONE           = 0,             /**<  Unknown access. */
    QL_NW_CELL_ACCESS_NORMAL_ONLY    = 1,             /**<  Normal access only.*/
    QL_NW_CELL_ACCESS_EMERGENCY_ONLY = 2,             /**<  Emergency access only. */
    QL_NW_CELL_ACCESS_NO_CALLS       = 3,             /**<  No access */
    QL_NW_CELL_ACCESS_ALL_CALLS      = 4,             /**<  All access. */
}QL_NW_CELL_ACCESS_STATE_TYPE_E;

/** wea config items */
typedef enum
{
    QL_NW_WEA_CONFIG_PRESIDENTIAL_ALERT     = (1 << 0),   /**<  Presidential alert.*/
    QL_NW_WEA_CONFIG_EXTREME_ALERT          = (1 << 1),   /**<  Extreme alert.*/
    QL_NW_WEA_CONFIG_SEVERE_ALERT           = (1 << 2),   /**<  Severe alert.*/
    QL_NW_WEA_CONFIG_AMBER_ALERT            = (1 << 3),   /**<  Amber alert.*/
    QL_NW_WEA_CONFIG_PUBLIC_SAFETY_ALERT    = (1 << 4),   /**<  Public safety alert.*/
    QL_NW_WEA_CONFIG_STATE_LOCAL_TEST_ALERT = (1 << 5),   /**<  State local test alert.*/
    QL_NW_WEA_CONFIG_RMT_ALERT              = (1 << 6),   /**<  RMT alert.*/
    QL_NW_WEA_CONFIG_EXERCISE_ALERT         = (1 << 7),   /**<  Exercise alert.*/
    QL_NW_WEA_CONFIG_CMSP_DEFINED_ALERT     = (1 << 8),   /**<  CMSP defined alert.*/
    QL_NW_WEA_CONFIG_SPANISH_ALERT          = (1 << 9),   /**<  Spanish-language alert.*/
} QL_NW_WEA_CONFIG_E;
...
typedef enum {
  QL_NW_RRC_STATE_UNKNOWN = 0,      /**<  RRC UNKNOWN. */
  QL_NW_RRC_STATE_IDLE = 1,         /**<  RRC IDLE. */
  QL_NW_RRC_STATE_CONNECTED = 2     /**<  RRC CONNECTED. */
}QL_NW_RRC_STATE_E;

typedef enum {
  QL_NW_DRX_DEFAULT = 0x00, /**<  DRX is not specified */
  QL_NW_DRX_CN6_T32 = 0x06, /**<   CN = 6, T = 32  */
  QL_NW_DRX_CN7_T64 = 0x07, /**<   CN = 7, T = 64  */
  QL_NW_DRX_CN8_T128 = 0x08, /**<  CN = 8, T = 128  */
  QL_NW_DRX_CN9_T256 = 0x09, /**<   CN = 9, T = 256   */
}QL_NW_DRX_E;

typedef struct 
{
    uint64_t   preferred_nw_mode;               /**<   Preferred network mode for connections; a bitmask of QL_NW_MODE_xxxx.*/
    QL_NW_ROAM_STATE_TYPE_E preferred_roaming;  /**<   depreferrted*/
...
typedef struct 
{
    char     nitz_time[QL_NW_NITZ_BUF_LEN + 1]; /**< UTC time in the format of YY/MM/DD,HH:MM:SS +/- TZ.
...
typedef struct 
{
    ql_nw_mobile_operator_name_info_t operator_name;   /**<   Operator.*/
    QL_NW_NETWORK_STATUS_TYPE_E       network_status;  /**<   Network status.*/
    QL_NW_RADIO_TECH_TYPE_E           rat;             /**<   Radio access technologies.*/
...
typedef struct {
  ...
  QL_NW_RADIO_TECH_TYPE_E radio_tech;       /**<   Radio technology.*/
  QL_NW_DENY_REASON_TYPE_E deny_reason;     /**<   Deny Reason.*/
}ql_nw_radio_tech_deny_reason_t;
...
typedef struct
{
    ...
    ql_nw_radio_tech_deny_reason_t deny_reason_list[QL_NW_RAT_DEYN_REASON_MAX_V01]; /**< Rat deny reason list */
...
typedef enum
{
    QL_NW_IMS_VOLTE_CONFIG      = (1 << 0),   /**<  config volte enable.*/
    QL_NW_IMS_ENABLE_CONFIG     = (1 << 1),   /**<  config ims enable.*/
    QL_NW_IMS_SMS_CONFIG        = (1 << 2),   /**<  config sms enable.*/
} QL_NW_IMS_CONFIG_E;
...
typedef struct
{
  ...
  uint8_t enable_endc;
}ql_nw_get_endc_config_t;

typedef struct
{
  uint8_t enable_endc;
}ql_nw_set_endc_config_t;
