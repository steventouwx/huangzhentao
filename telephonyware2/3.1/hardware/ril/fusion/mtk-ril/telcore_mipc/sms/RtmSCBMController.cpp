...
/*****************************************************************************
 * Class RtmSCBMController
 *****************************************************************************/

RFX_IMPLEMENT_CLASS("RtmSCBMController", RtmSCBMController, RfxController);
...
RtmSCBMController::RtmSCBMController() : m_timer(NULL) {
    setTag(String8("RtmSCBM"));
    logD(mTag, "RtmSCBMController: constructor");
}

RtmSCBMController::~RtmSCBMController() {
}

void RtmSCBMController::onInit() {
...
void RtmSCBMController::onDeinit() {
    RfxController::onDeinit();
}

bool RtmSCBMController::onHandleRequest(const sp<RfxMessage>& message) {
...
void RtmSCBMController::onTimer() {
...
bool RtmSCBMController::onHandleUrc(const sp<RfxMessage>& msg) {
    ...
    switch (msg_id) {
        case RFX_MSG_URC_ENTER_SMS_SCBM:
            ...
            m_timer = RfxTimer::start(RfxCallback0(this, &RtmSCBMController::onTimer),
                    s2ns(SCM_EXIT_TIME));
            responseToRilj(msg);
            break;
