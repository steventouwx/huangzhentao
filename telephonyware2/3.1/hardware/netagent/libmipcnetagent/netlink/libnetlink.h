...
int rtnl_linkdump_req(struct rtnl_handle_nl *rth, int fam)
	__attribute__((warn_unused_result));
int rtnl_linkdump_req_filter(struct rtnl_handle_nl *rth, int fam, __u32 filt_mask)
	__attribute__((warn_unused_result));

int rtnl_linkdump_req_filter_fn(struct rtnl_handle_nl *rth, int fam,
				req_filter_fn_t fn)
	__attribute__((warn_unused_result));
...
int rtnl_statsdump_req_filter(struct rtnl_handle_nl *rth, int fam, __u32 filt_mask)
	__attribute__((warn_unused_result));
int rtnl_dump_request(struct rtnl_handle_nl *rth, int type, void *req,
			     int len)
	__attribute__((warn_unused_result));
...
int rtnl_talk_suppress_rtnl_errmsg(struct rtnl_handle_nl *rtnl, struct nlmsghdr *n,
				   struct nlmsghdr **answer)
	__attribute__((warn_unused_result));
int rtnl_send(struct rtnl_handle_nl *rth, const void *buf, int)
	__attribute__((warn_unused_result));
int rtnl_send_check(struct rtnl_handle_nl *rth, const void *buf, int)
	__attribute__((warn_unused_result));
...
int rtnl_listen_all_nsid(struct rtnl_handle_nl *);
int rtnl_listen(struct rtnl_handle_nl *, rtnl_listen_filter_t handler,
		void *jarg);
