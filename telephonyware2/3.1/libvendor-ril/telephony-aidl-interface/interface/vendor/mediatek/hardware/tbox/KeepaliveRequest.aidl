...
parcelable KeepaliveRequest {
    ...
    /**
     * TCP keepalive specified by RFC 1122 Section 4.2
     */
    const int TYPE_IPV4_TCP = 2;
    /**
     * UDP keepalive specified by RFC 1122 Section 4.1
     */
    const int TYPE_IPV4_UDP = 3;
    /**
     * TCP keepalive specified by RFC 1122 Section 4.2
     */
    const int TYPE_IPV6_TCP = 4;
    /**
     * UDP keepalive specified by RFC 1122 Section 4.1
     */
    const int TYPE_IPV6_UDP = 5;
    /**
