...
typedef RfxCallback2<RIL_Errno, int> RtcModuleRequestRadioCallback;
/*****************************************************************************
 * Class RfxController
 *****************************************************************************/
...
class RtcRadioController : public RfxController {
    ...
    private:
        ...
        RtcModuleRequestRadioCallback findCallback(
        ...
        std::unordered_map<int, RtcModuleRequestRadioCallback> mCallbackMap;
        RtcModuleRequestRadioCallback mEmptyCallback;
