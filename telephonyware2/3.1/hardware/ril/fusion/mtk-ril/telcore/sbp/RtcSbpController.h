...
#ifndef __RTC_SBP_CONTROLLER_H__
#define __RTC_SBP_CONTROLLER_H__
...
typedef enum {
    RTC_SBP_AUTO_SWITCH = 1,
    RTC_SBP_ONLY_CHECK_FIRST_SIM = 2,
    RTC_SBP_MANUAL_SWITCH = 3,
    RTC_SBP_ALWAYS_ASK = 4,
} RTC_SBP_SWITCH_MODE;

#define RTC_SBP_CXP_SET_SBP  (0)
#define RTC_SBP_RILD_SET_SBP (1)
#define RTC_SBP_MODEM_PARTIALLY_SET_SBP (2)
#define RTC_SBP_MODEM_SET_SBP (3)

/*****************************************************************************
 * Class RfxController
 *****************************************************************************/
class RtcSbpController : public RfxController {
    // Required: declare this class
    RFX_DECLARE_CLASS(RtcSbpController);

public:
    RtcSbpController();
    virtual ~RtcSbpController();
...
#endif /* __RTC_SBP_CONTROLLER_H__ */
