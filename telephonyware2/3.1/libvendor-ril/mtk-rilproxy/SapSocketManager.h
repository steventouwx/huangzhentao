...
static pthread_mutex_t sap_socket_gsm_mutex[SIM_COUNT];
static pthread_mutex_t sap_socket_c2k_mutex[SIM_COUNT];
static pthread_mutex_t sap_socket_bt_mutex[SIM_COUNT];
static int socket_sap_gsm_fds[SIM_COUNT];
static int socket_sap_c2k_fds[SIM_COUNT];
static int socket_sap_bt_fds[SIM_COUNT];
const char PROPERTY_RIL_FULL_UICC_TYPE[4][25] = {
