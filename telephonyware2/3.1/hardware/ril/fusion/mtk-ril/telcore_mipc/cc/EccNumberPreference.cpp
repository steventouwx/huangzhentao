...
void EccNumberPreference::setPreferenceList(int preferenceType, String8 preferenceList) {
    if (RfxRilUtils::getRilRunMode() == RilRunMode::RIL_RUN_MODE_MOCK) {
        switch (preferenceType) {
            case 'GOLY':
                mGsmOnlyNumberList = preferenceList;
                break;
            case 'GPRF':
                mGsmPreferredNumberList = preferenceList;
                break;
            case 'CPRF':
                mCdmaPreferredNumberList = preferenceList;
                break;
            default:
                break;
        }
