...
typedef enum {
    ...
    RFX_MSG_WR_START,
    #include "RfxWrMessageId.h"
    RFX_MSG_WR_END = RFX_MSG_WR_START + DEFAULT_MSG_RANGE,
    ...
    RFX_MSG_DC_START,
    #include "RfxDchMessageId.h"
    RFX_MSG_DC_END = RFX_MSG_DC_START + DEFAULT_MSG_RANGE,
    /* Please add your default value above this line */
    RFX_MSG_ECALL_START,
    #include "RfxEcallMessageId.h"
    RFX_MSG_ECALL_END = RFX_MSG_ECALL_START + DEFAULT_MSG_RANGE,
