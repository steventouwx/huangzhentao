...
#ifndef __RMM_OEM_REQUEST_HANDLER_H__
#define __RMM_OEM_REQUEST_HANDLER_H__
...
class RmmOemRequestHandler : public RfxBaseHandler {
    RFX_DECLARE_HANDLER_CLASS(RmmOemRequestHandler);

    public:
        RmmOemRequestHandler(int slot_id, int channel_id);
        virtual ~RmmOemRequestHandler();
    ...
    private:
        ...
        void requestSetHsrMode(const sp<RfxMclMessage>& msg);

        void requestNvResetConfig(const sp<RfxMclMessage>& msg);
        ...
        void requestDeviceImei(const sp<RfxMclMessage>& msg);

        void handleSetTxPowerRequest(const sp<RfxMclMessage>& msg);

        void syncAppEventStatusRequest(const sp<RfxMclMessage>& msg);
        ...
        bool sendOemToNwModule(char *string);
