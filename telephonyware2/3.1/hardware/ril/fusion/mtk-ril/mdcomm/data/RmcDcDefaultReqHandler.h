...
class RmcDcDefaultReqHandler : public RmcDcCommonReqHandler {
    public:
        ...
        virtual void onUrspReevaluate(const sp<RfxMclMessage>& msg);
        virtual void onDataRatUpdated(const sp<RfxMclMessage>& msg);
        virtual void onAttachApnChanged(const char* apn);
