...
private:
    ...
    void onNotifyCallState(const sp<RfxMessage>& message);
    void onHandleIncomingCallIndicate(const sp<RfxMessage>& message);
    void speechonoff(int count);
    int mixer_init();

private:
    int mCsPhone;
    int mCallCount;
    RfxCallState mCurrentCallState;
};
