...
public:
    ...
    static int getSystemPropValueWithDefault(const char* propName, const char * defaultValue);
    ...
    static bool isOp09SimCard(const char* icc_id);
    static bool isOp01SimCard(const char* icc_id);
    static bool hasForceSetVoNRValue();
    static int getforceSetVoNRValue();
    static int getCnopVoWifiSupportState();
...
public:
    ...
    static const char* PROPERTY_VONR_FORCE_ENABLE;
    static const char* PROPERTY_5G_VOWIFI_FORCE_ENABLE;
    static const char* PROPERTY_VINR_ENALBE;
    static const char* PROPERTY_VODATA_ENALBE;
    ...
    static const char* PROPERTY_VONR_SETTING_SUPPORT;
    static const char* PROPERTY_VENDOR_OPERATOR_OPTR;
