...
#include "RmmOpSuppServRequestHandler.h"
...
RFX_IMPLEMENT_OP_HANDLER_CLASS(RmmOpSuppServRequestHandler, RIL_CMD_PROXY_2);

RmmOpSuppServRequestHandler::RmmOpSuppServRequestHandler(int slot_id,
        int channel_id):RfxBaseHandler(slot_id, channel_id){
    registerToHandleRequest(requests, sizeof(requests)/sizeof(int));
}

RmmOpSuppServRequestHandler::~RmmOpSuppServRequestHandler() {
}

void RmmOpSuppServRequestHandler::onHandleRequest(const sp<RfxMclMessage>& msg) {
...
void RmmOpSuppServRequestHandler::onHandleTimer() {
    // do something
}

void RmmOpSuppServRequestHandler::requestSendUssiFrom(const sp<RfxMclMessage>& msg) {
...
void RmmOpSuppServRequestHandler::requestCancelUssiFrom(const sp<RfxMclMessage>& msg) {

    const char* from = (const char*) (msg->getData()->getData());
    sp<RfxAtResponse> p_response;
    int err;
    RIL_Errno ret = RIL_E_GENERIC_FAILURE;
