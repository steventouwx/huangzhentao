 ...
 * Value is in Integer format, in milliseconds.
 */
...
/**
 * VoNR setting enabled, Enabled (1), or Disabled (0)
 * Value is in Integer format.
 */
            IMS_CONFIG_VONR_SETTING_ENABLED = IMS_CONFIG_MTK_PROVISIONED_START + 4,
 ...
 */
            IMS_CONFIG_MTK_PROVISIONED_END =
                               IMS_CONFIG_VONR_SETTING_ENABLED,
...
typedef enum {
    ...
    FEATURE_TYPE_VOICE_CROSS_SIM = 8,
    FEATURE_TYPE_CALL_COMPOSER = 9,
} ImsFeatureType;
