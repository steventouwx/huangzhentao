...
#ifndef __RIL_DEFAULT_CLIENT_H__
#define __RIL_DEFAULT_CLIENT_H__
...
class RilDefaultClient : public RilClient {

public:

    RilDefaultClient(int identity, char* clientName);
    virtual ~RilDefaultClient();
    ...
    {
    public:
        StateActivityThread(RilDefaultClient* client);
        virtual ~StateActivityThread();

    protected:
        RilDefaultClient* client;
