...
class RmcDcPdnManager: public RfxBaseHandler {
    ...
    public:
        ...
        void setQosFilters(int aid, int filterCount, RIL_QosFilter* qosFilter);
...
inline void RmcDcPdnManager::updateMtuV6(int aid, int mtuV6) {
    RFX_ASSERT(validateAid(aid));
...
inline void RmcDcPdnManager::setAccessNetwork(int aid, int accessNetwork) {
    RFX_ASSERT(validateAid(aid));
    m_pPdnInfo[aid].accessNetwork = accessNetwork;
}

inline void RmcDcPdnManager::setQosSessionCount(int aid, int qosSessionCount) {
    RFX_ASSERT(validateAid(aid));
    m_pPdnInfo[aid].qosSessionCount = qosSessionCount;
}

inline void RmcDcPdnManager::setHandoverFailureMode(int aid, int handoverFailureMode) {
    RFX_ASSERT(validateAid(aid));
    m_pPdnInfo[aid].handoverFailureMode = handoverFailureMode;
}

inline void RmcDcPdnManager::setPduSessionId(int aid, int pduSessionId) {
    RFX_ASSERT(validateAid(aid));
...
inline int RmcDcPdnManager::getMtuV6(int aid) {
    RFX_ASSERT(validateAid(aid));
    return m_pPdnInfo[aid].mtuV6;
}

inline int RmcDcPdnManager::getRat(int aid) {
    RFX_ASSERT(validateAid(aid));
...
inline int RmcDcPdnManager::getAccessNetwork(int aid) {
    RFX_ASSERT(validateAid(aid));
    return m_pPdnInfo[aid].accessNetwork;
}

inline RIL_Qos* RmcDcPdnManager::getDefaultQos(int aid) {
    RFX_ASSERT(validateAid(aid));
    return m_pPdnInfo[aid].defaultQos;
}

inline int RmcDcPdnManager::getQosSessionCount(int aid) {
    RFX_ASSERT(validateAid(aid));
    return m_pPdnInfo[aid].qosSessionCount;
}

inline RIL_QosSession* RmcDcPdnManager::getQosSession(int aid) {
    RFX_ASSERT(validateAid(aid));
    return m_pPdnInfo[aid].qosSession;
}

inline int RmcDcPdnManager::getHandoverFailureMode(int aid) {
    RFX_ASSERT(validateAid(aid));
    return m_pPdnInfo[aid].handoverFailureMode;
}

inline int RmcDcPdnManager::getPduSessionId(int aid) {
    RFX_ASSERT(validateAid(aid));
    return m_pPdnInfo[aid].pduSessionId;
}

inline RIL_SliceInfo* RmcDcPdnManager::getSliceInfo(int aid) {
    RFX_ASSERT(validateAid(aid));
    return m_pPdnInfo[aid].optionalSliceInfo;
}

inline int RmcDcPdnManager::getTdCount(int aid) {
    RFX_ASSERT(validateAid(aid));
    return m_pPdnInfo[aid].tdCount;
}

inline RIL_TrafficDescriptor* RmcDcPdnManager::getTds(int aid) {
    RFX_ASSERT(validateAid(aid));
