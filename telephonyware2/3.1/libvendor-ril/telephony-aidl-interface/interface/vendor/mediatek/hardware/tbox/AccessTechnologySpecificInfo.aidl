...
import vendor.mediatek.hardware.tbox.Cdma2000RegistrationInfo;
import vendor.mediatek.hardware.tbox.EutranRegistrationInfo;
import vendor.mediatek.hardware.tbox.NrVopsInfo;
