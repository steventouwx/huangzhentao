...
#ifndef __RMM_PHB_URC_HANDLER_H__
#define __RMM_PHB_URC_HANDLER_H__
...
class RmmPhbURCHandler : public RfxBaseHandler {
    RFX_DECLARE_HANDLER_CLASS(RmmPhbURCHandler);

    public:
        RmmPhbURCHandler(int slot_id, int channel_id);
        virtual ~RmmPhbURCHandler();
