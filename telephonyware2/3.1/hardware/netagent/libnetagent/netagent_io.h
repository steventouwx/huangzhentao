...
#define MAX_RA_PAYLOAD_LENGTH 480
...
typedef enum {
    ...
    NETAGENT_IO_CMD_REALLOCATE_SPI  = 303,
    NETAGENT_IO_CMD_SPI_QUERY       = 304,
    NETAGENT_IO_CMD_SET_NO_RA       = 305,
...
typedef enum {
    NETAGENT_IO_SIP_ADDR_SRC       = 0,
    NETAGENT_IO_SIP_ADDR_DST       = 1,
} netagent_io_sip_addr_whom_e;
...
void *netagent_io_cmd_rapayload_alloc(char *raPayload);
...
void *netagent_io_cmd_free_multi_spi_alloc(unsigned int transaction_id, unsigned int action, unsigned int count, const char* response);
void *netagent_io_cmd_spi_query_alloc();
...
int netagent_io_get_spi_addr_v4(void *co, netagent_io_sip_addr_whom_e whom, unsigned int *addr);
int netagent_io_get_spi_addr_v6(void *co, netagent_io_sip_addr_whom_e whom, unsigned int *addr);

void *netagent_io_recv(void *o, int isUserBuild) ;
