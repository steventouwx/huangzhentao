...
#define CDMA_ALPHA_INFO_BUFFER_LENGTH_MTK 64
#define CDMA_NUMBER_INFO_BUFFER_LENGTH_MTK 81
...
#define RIL_MAX_DNN_COUNT       1
#define RIL_MAX_DNN_CHAR_COUNT  100
#define MAX_COUNT_NR_CSI_CQI_REPORT 19
#define MAX_BARRING_INFO_COUNT 39

#define MAX_DCMAP_NUM_PER_CONFIG 10
#define MAX_DC_TLS_ID_LENGTH     256
#define MAX_BDC_CONFIG_NUM  2
#define MAX_BDC_DCMAP_NUM   20
#define MAX_ADC_CONFIG_NUM  4
#define MAX_ADC_DCMAP_NUM   40
#define MAX_DC_CONFIG_NUM   6
#define MAX_DC_DCMAP_NUM    60
#define MAX_DC_IP_ADDR_LENGTH  16
#define MAX_DC_IF_NAME_LENGTH  16
#define MAX_DC_FINGERPRINT_LENGTH  192
#define MAX_DC_QOS_HINT_LENGTH  64
#define MAX_DCMAP_LABEL_LENGTH  80
#define MAX_DCMAP_SUBPROTOCOL_LENGTH 10
#define MAX_DATA_CHANNEL_XML_DATA_LEN 64000
#define MAX_DC_RSP_CAUSE_CANCLED  1000
...
typedef unsigned int RIL_SOCKET_ID;
...
typedef struct {
    ...
    char *          forwardedNumber;  /* See 3GPP TS 24.008 section 10.5.4.21b(+EAIC redirected number)*/
} RIL_Call;
...
typedef enum {
    ...
    AIEC = 1 << 6,
    /**
     * Extended URN received in +CEN4
     */
    EXTENDED_SUB_SERVICE = 1 << 14
...
typedef struct {
    ...
    /**
     * Below is added for CarrierRestrictions in AIDL v2.
     */
...
typedef enum {
    DSI_CE_TYPE_3GPP_SPEC_DEFINED = 0x06, //Network cause reported
    DSI_CE_TYPE_INTERNAL = 0x02, // Local cause reported
} RIL_CauseType;
...
typedef enum {
    ...
    PDP_FAIL_VSNCP_APN_UNAUTHORIZED = 0x8BE,
    ...
    PDP_FAIL_ALL_MATCHING_RULES_FAILED = 0x8CE,
    ...
    PDP_FAIL_D2CPM_ALREADY_IN_USE = 0x16D7,  /* M */
    PDP_FAIL_REJECTED_BY_IWLAN = 0x16F1,  /* M */
    PDP_FAIL_VGSM_REACTIVATION_REQUESTED = 0x1A27,  /* M */

    PDP_FAIL_IWLAN_PDN_CONNECTION_REJECTION = 0x2000,
    PDP_FAIL_IWLAN_MAX_CONNECTION_REACHED = 0x2001,
    PDP_FAIL_IWLAN_SEMANTIC_ERROR_IN_THE_TFT_OPERATION = 0x2031,
    PDP_FAIL_IWLAN_SYNTACTICAL_ERROR_IN_THE_TFT_OPERATION = 0x2032,
    PDP_FAIL_IWLAN_SEMANTIC_ERRORS_IN_PACKET_FILTERS = 0x2034,
    PDP_FAIL_IWLAN_SYNTACTICAL_ERRORS_IN_PACKET_FILTERS = 0x2035,
    PDP_FAIL_IWLAN_NON_3GPP_ACCESS_TO_EPC_NOT_ALLOWED = 0x2328,
    PDP_FAIL_IWLAN_USER_UNKNOWN = 0x2329,
    PDP_FAIL_IWLAN_NO_APN_SUBSCRIPTION = 0x232A,
    PDP_FAIL_IWLAN_AUTHORIZATION_REJECTED = 0x232B,
    PDP_FAIL_IWLAN_ILLEGAL_ME = 0x232E,
    PDP_FAIL_IWLAN_NETWORK_FAILURE = 0x2904,
    PDP_FAIL_IWLAN_RAT_TYPE_NOT_ALLOWED = 0x2AF9,
    PDP_FAIL_IWLAN_IMEI_NOT_ACCEPTED = 0x2AFD,
    PDP_FAIL_IWLAN_PLMN_NOT_ALLOWED = 0x2B03,
    PDP_FAIL_IWLAN_UNAUTHENTICATED_EMERGENCY_NOT_SUPPORTED = 0x2B2F,
    PDP_FAIL_IWLAN_IKEV2_CONFIG_FAILURE = 0x4000,
    PDP_FAIL_IWLAN_IKEV2_AUTH_FAILURE = 0x4001,
    PDP_FAIL_IWLAN_IKEV2_MSG_TIMEOUT = 0x4002,
    PDP_FAIL_IWLAN_IKEV2_CERT_INVALID = 0x4003,
    PDP_FAIL_IWLAN_DNS_RESOLUTION_NAME_FAILURE = 0x4004,
    PDP_FAIL_IWLAN_DNS_RESOLUTION_TIMEOUT = 0x4005,
    ...
    PDP_FAIL_HANDOVER_FAILED = 0x10006,
    PDP_FAIL_DUPLICATE_CID = 0x10007,
    PDP_FAIL_NO_DEFAULT_DATA = 0x10008,
    PDP_FAIL_SERVICE_TEMPORARILY_UNAVAILABLE = 0x10009,
    PDP_FAIL_REQUEST_NOT_SUPPORTED = 0x1000A,
    PDP_FAIL_NO_RETRY_FAILURE = 0x1000B,
...
typedef enum {
    ...
    RIL_DATA_PROFILE_VENDOR_EMERGENCY  = RIL_DATA_PROFILE_OEM_BASE + 4,
    RIL_DATA_PROFILE_VENDOR_XCAP       = RIL_DATA_PROFILE_OEM_BASE + 5,
    RIL_DATA_PROFILE_VENDOR_RCS        = RIL_DATA_PROFILE_OEM_BASE + 6,
    RIL_DATA_PROFILE_VENDOR_BIP        = RIL_DATA_PROFILE_OEM_BASE + 7,
    RIL_DATA_PROFILE_VENDOR_VSIM       = RIL_DATA_PROFILE_OEM_BASE + 8,
    RIL_DATA_PROFILE_VENDOR_MCX        = RIL_DATA_PROFILE_OEM_BASE + 9,
    RIL_DATA_PROFILE_VENDOR_ALL        = RIL_DATA_PROFILE_OEM_BASE + 10,

    RIL_DATA_PROFILE_VENDOR_ENTERPRISE = RIL_DATA_PROFILE_OEM_BASE + 100,
    // MTK end
...
typedef enum {
    ...
    // MTK added
    RIL_PERSOSUBSTATE_SIM_SIM_C                 = 100,
    RIL_PERSOSUBSTATE_SIM_SIM_C_PUK             = 101,
} RIL_PersoSubstate;
...
typedef enum {
    ...
    RIL_UNKNOWN_AND_EMERGENCY_AVAILABLE = 14,    // Same as UNKNOWN but indicates that
                                                 // emergency calls are enabled.
    RIL_REG_EMERGENCY_AVAILABLE = 20,            // Emergency attached in EPS or in 5GS
} RIL_RegState;
...
typedef struct {
     ...
     */
    int32_t csiCqiTableIndex;

    uint32_t csiCqiReportCount; /* the number of csiCqiReport*/
    /**
     ...
     */
    uint8_t csiCqiReport[MAX_COUNT_NR_CSI_CQI_REPORT];
...
typedef struct {
    ...
    int bsic;/* 6-bit Base Station Identity Code, 0xFF if unknown */
...
typedef enum {
    ...
    COMBINED
} RIL_AttachResultType;

typedef enum {
    /** None */
    EXTRA_NONE = 0,
    /** LTE combined attach with CSFB not preferred */
    EXTRA_CSFB_NOT_PREFERRED = 1 << 0,
...
typedef struct {
    ...
    NrVopsInfo nrVopsInfo;   // NR network capability
    /**
    ...
    char rplmn[8];
    RIL_AttachResultType attachResultType;
    RIL_ExtraInfo extraInfo;
...
typedef struct {
    ...
    size_t count_barringInfo;
    RIL_BarringInfo barringInfos[MAX_BARRING_INFO_COUNT];// the max is 39 for 5G
} RIL_BarringInforResponse;
...
} RIL_RegistrationFailedResponse;

typedef enum {
    RIL_USAGE_CS_CENTRIC = 1,
    RIL_USAGE_PS_CENTRIC = 2,
} RIL_USAGE_SETTING;
...
typedef struct {
    ...
    int lte_cqi_table_index; // Rang[1, 6]. INT_MAX means  invalid/unreported
    int nr_csicqi_table_index; //Rang [1, 3], INT_MAX means  invalid/unreported
    int nr_csicqi_report_count;
    uint8_t nr_csicqi_reports[MAX_COUNT_NR_CSI_CQI_REPORT]; //rang [0, 15], 0xff means invalid
    int nr_timing_advance;
} RIL_SIGNAL_STRENGTH;
...
typedef struct {
  char alpha_len;
  char alpha_buf[CDMA_ALPHA_INFO_BUFFER_LENGTH_MTK];
...
typedef struct {
  char len;
  char buf[CDMA_NUMBER_INFO_BUFFER_LENGTH_MTK];
  char number_type;
  char number_plan;
  char pi;
  char si;
...
#define SS_INFO_MAX_MTK 4
#define NUM_SERVICE_CLASSES_MTK 7
...
typedef struct {
  ...
  RIL_CallForwardInfo cfInfo[NUM_SERVICE_CLASSES_MTK]; /* This is the response data
...
typedef struct {
  ...
  union {
    int ssInfo[SS_INFO_MAX_MTK]; /* This is the response data for most of the SS GET/SET
...
typedef struct {
    ...
    /** the bearer bitmask. See RIL_RadioAccessFamily for the value of each bit. */
    int bearerBitmask;
    /** maximum transmission unit (MTU) size in bytes of IPV4*/
    int mtu;
    /** maximum transmission unit (MTU) size in bytes of IPV6*/
    int mtuV6;
    /** the MVNO type: possible values are "imsi", "gid", "spn" */
    char *mvnoType;
    /** MVNO match data. Can be anything defined by the carrier. For example,
...
typedef enum {
    ...
    RIL_APN_TYPE_VSIM         = 0x1000,       // APN type for VSIM
    RIL_APN_TYPE_BIP          = 0x2000,       // APN type for BIP
    RIL_APN_TYPE_ENTERPRISE   = 0x4000,       // APN type for ENTERPRISE
    RIL_APN_TYPE_RCS          = 0x8000,       // APN type for RCS

    RIL_APN_TYPE_COUNT        = 16,

    RIL_APN_TYPE_ALL          = RIL_APN_TYPE_DEFAULT | RIL_APN_TYPE_HIPRI | RIL_APN_TYPE_MMS |
                                RIL_APN_TYPE_SUPL | RIL_APN_TYPE_DUN | RIL_APN_TYPE_FOTA |
                                RIL_APN_TYPE_IMS | RIL_APN_TYPE_CBS,

    RIL_APN_TYPE_MTKALL       = RIL_APN_TYPE_ALL | RIL_APN_TYPE_XCAP |
...
typedef enum {
    RAN_UNKNOWN = 0x00, // Unknown access network
...
typedef enum {
    ...
    GERAN_BAND_ER900 = 14,
    GERAN_BAND_MAX = GERAN_BAND_ER900,
} RIL_GeranBands;
...
typedef enum {
    ...
    EUTRAN_BAND_87 = 87,
    EUTRAN_BAND_88 = 88,
    EUTRAN_BAND_MAX = EUTRAN_BAND_88,
} RIL_EutranBands;
...
typedef struct {
    ...
    union {
        ...
        RIL_NgranBands ngranBands[MAX_BANDS];
    } bands;
...
typedef struct {
    ...
    int32_t cellBandwidthDownlink;//cellBandwidthDownlinkKhz
    int32_t cellBandwidthUplink;//cellBandwidthUplinkKhz
    FrequencyRange fr;
...
typedef struct {
    ...
    uint8_t isFake;     // The fake ecc (normal call) or not
} RIL_EmergencyNumber;
 ...
 */
typedef struct {
    uint16_t dcmap_stream_id;
    uint16_t priority;
    uint8_t  ordered;
    uint32_t max_retr;
    uint32_t max_time;
    char*    label; //MAX_DCMAP_LABEL_LENGTH
    char*    subprotocol; //MAX_DCMAP_SUBPROTOCOL_LENGTH
} RIL_DchMapStruct;

typedef struct {
    uint8_t callId;
    uint8_t closeAllStream;
    uint8_t  dcmap_count;
    uint8_t  dc_config_index[MAX_DCMAP_NUM_PER_CONFIG]; //Mapping to related DC config
    uint16_t dcmap_stream_id[MAX_DCMAP_NUM_PER_CONFIG]; //The 'dcmap-stream-id' parameter indicates the SCTP stream identifier within the SCTP association used to form the data channel. dcmap-stream-id = 1*5DIGIT
} RIL_DchMapDelStruct;
...
typedef struct {
    ...
    uint8_t  index; //Index of the Config
    uint8_t  local_dtls_setup; //Indicates the role when creating DTLS association
    char*    local_tls_id; // MAX_DC_TLS_ID_LENGTH, DTLS association ID, tls-id-value = 20*(tls-id-char)
    uint16_t fp_hash_func; //Could be sha-256, sha-384, sha-512, normally we use sha-256 /* dc_fp_hash_func_enum */
    char*    local_fp_str; //MAX_DC_FINGERPRINT_LENGTH
    uint32_t local_max_message_size; //The maximum SCTP size peer could receive according to SDP negotiation
    uint32_t data_b_as; //Bandwidth for this DC stream
    char*    qos_hint; //MAX_DC_QOS_HINT_LENGTH, TS 26.114   e.g.: loss=0.000002,latency=1000
    uint8_t  dcmap_count;
    //RIL_DcMapStruct dcmap[MAX_DCMAP_NUM_PER_CONFIG];
    uint16_t dcmap_stream_id[MAX_DCMAP_NUM_PER_CONFIG];
    uint16_t dcmap_priority[MAX_DCMAP_NUM_PER_CONFIG];
    uint8_t  dcmap_ordered[MAX_DCMAP_NUM_PER_CONFIG];
    uint32_t dcmap_max_retr[MAX_DCMAP_NUM_PER_CONFIG];
    uint32_t dcmap_max_time[MAX_DCMAP_NUM_PER_CONFIG];
    char*    dcmap_label[MAX_DCMAP_NUM_PER_CONFIG]; //MAX_DCMAP_LABEL_LENGTH
    char*    dcmap_subprotocol[MAX_DCMAP_NUM_PER_CONFIG]; //MAX_DCMAP_SUBPROTOCOL_LENGTH
}  RIL_DchConfigLocal;

/**
 * Structure for all data media parameters.
 */
typedef struct {
    uint8_t  call_id;
    uint8_t  result;
    ...
    uint16_t local_udp_port;
    uint16_t local_sctp_port;
    uint8_t  remote_addr[MAX_DC_IP_ADDR_LENGTH]; //MAX_DC_IP_ADDR_LENGTH, Remote IP address in binary, 16 bytes
    uint8_t  local_addr[MAX_DC_IP_ADDR_LENGTH];   //MAX_DC_IP_ADDR_LENGTH, Local IP address in binary, 16 bytes
    uint8_t  remote_dtls_setup;
    uint8_t  local_dtls_setup;
    uint16_t fp_hash_func;
    char*    remote_tls_id;//MAX_DC_TLS_ID_LENGTH, DTLS association ID, tls-id-value = 20*(tls-id-char)
    char*    local_tls_id;
    char*    remote_fp_str; //MAX_DC_FINGERPRINT_LENGTH
    char*    local_fp_str;
    uint32_t remote_max_message_size;
    uint32_t local_max_message_size;
    uint32_t data_b_as; //Bandwidth for this DC stream
    char*    qos_hint; //MAX_DC_QOS_HINT_LENGTH, TS 26.114   e.g.: loss=0.000002,latency=1000
...
/**
 * Structure of all data media parameters from IMSUA
 */
typedef struct  {
    uint32_t call_id;
    char*    if_name; //
    uint32_t dc_config_num;   //The number of valid dc_config structure
    RIL_DchConfig dc_config_list[MAX_DC_CONFIG_NUM]; //RFC 8864. Defines data channel parameters(Note: MAX_DCMAP_NUM = 6)
} RIL_DchImsDataConfig;
...
} RIL_NasProtocolMessage;

typedef struct  {
    char plmn[8]; //
    RIL_CellularIdentifier identifier;
    RIL_NasProtocolMessage protocolMessage;
    bool isEmergency;
...
#define RIL_REQUEST_SET_NETWORK_SELECTION_MANUAL_WITH_RAN 155
#define RIL_REQUEST_GET_BARRINGINFO 156
 ...
 *  REQUEST_NOT_SUPPORTED
*/
#define RIL_REQUEST_ENABLE_UICC_APPLICATIONS 157
 ...
 *  REQUEST_NOT_SUPPORTED
 */
#define RIL_REQUEST_ARE_UICC_APPLICATIONS_ENABLED 158

#define RIL_REQUEST_SET_MODEM_CONFIG 159
...
#define RIL_REQUEST_ENTER_SIM_DEPERSONALIZATION 160

/**
 * RIL_REQUEST_CDMA_SEND_SMS_EXPECT_MORE
 *
 * Send a CDMA SMS message. Identical to RIL_REQUEST_CDMA_SEND_SMS,
 ...
 *
 */
#define RIL_REQUEST_CDMA_SEND_SMS_EXPECT_MORE 161
 ...
 */
#define RIL_REQUEST_ALLOCATE_PDU_SESSION_ID 162
 ...
 */
#define RIL_REQUEST_RELEASE_PDU_SESSION_ID 163
 ...
 */
#define RIL_REQUEST_START_HANDOVER 164
 ...
 */
#define RIL_REQUEST_CANCEL_HANDOVER 165
 ...
 *  CANCELLED
 */
#define RIL_REQUEST_SET_ALLOWED_NETWORK_TYPES_BITMAP 167
 ...
 *  CANCELLED
 *
 * See also: RIL_REQUEST_SET_ALLOWED_NETWORK_TYPES_BITMAP
 */
...
/**
  ...
  */
#define RIL_REQUEST_SET_NRDC_STATE 173
...
/**
  ...
  *   RadioError:REQUEST_NOT_SUPPORTED
  */
#define RIL_REQUEST_GET_NRDC_STATE 174
 ...
 */
#define RIL_REQUEST_GET_SYSTEM_SELECTION_CHANNELS 175
 ...
 */
#define RIL_REQUEST_ENABLE_VONR 176
 ...
 */
#define RIL_REQUEST_IS_VONR_ENABLED 177

//NW
#define RIL_REQUEST_SET_USAGE_SETTING 178
#define RIL_REQUEST_GET_USAGE_SETTING 179
#define RIL_REQUEST_IS_N1_MODE_ENABLED 180
#define RIL_REQUEST_SET_N1_MODE_ENABLED 181

#define RIL_REQUEST_SET_SRVCC_CALL_INFO          182
#define RIL_REQUEST_UPDATE_IMS_REGISTRATION_INFO 183
#define RIL_REQUEST_START_IMS_TRAFFIC      184
#define RIL_REQUEST_STOP_IMS_TRAFFIC       185
#define RIL_REQUEST_SEND_ANBR_QUERY        186
#define RIL_REQUEST_TRIGGER_EPS_FALLBACK   187
#define RIL_REQUEST_UPDATE_IMS_CALL_STATUS 188

/**
 * RIL_REQUEST_DEVICE_IMEI
 *
 * get device IMEI and IMEI software version
 */
#define RIL_REQUEST_DEVICE_IMEI 189

#define RIL_REQUEST_SET_EMERGENCY_MODE 190
#define RIL_REQUEST_TRIGGER_EMERGENCY_NETWORK_SCAN 191
#define RIL_REQUEST_CANCEL_EMERGENCY_NETWORK_SCAN 192
#define RIL_REQUEST_EXIT_EMERGENCY_MODE 193
#define RIL_REQUEST_SET_NULL_CIPHER_AND_INTEGRITY_ENABLED 194
#define RIL_REQUEST_IS_NULL_CIPHER_AND_INTEGRITY_ENABLED 195
#define RIL_REQUEST_SIM_CLOSE_CHANNEL_WITH_SESSION 196

#define RIL_REQUEST_IS_CELLULAR_IDENTIFIER_TRANSPARENCY_ENABLED 197
#define RIL_REQUEST_SET_CELLULAR_IDENTIFIER_TRANSPARENCY_ENABLED 198
#define RIL_REQUEST_SET_SECURITY_ALGORITHMS_UPDATED_ENABLED 199
#define RIL_REQUEST_IS_SECURITY_ALGORITHMS_UPDATED_ENABLED 200
#define RIL_REQUEST_GET_SIMULTANEOUS_CALLING_SUPPORT 201
 ...
 *
 * Indicated when there is a change in APPLICATIONS status.
 * This event will be sent in the following scenarios
 *  - APPLICATIONS readiness at modem, which was selected by telephony layer
 *  - when APPLICATIONS is enabled/disabled by modem due to UICC card mount/removal
 *  - when APPLICATIONS is enabled/disabled by AP due to end user operation
 *
 * "data" is const int *
 * ((const int *)data)[0] == 0 for APPLICATIONS Enabled
 * ((const int *)data)[0] == 1 for APPLICATIONS Disabled
 *
 */
#define RIL_UNSOL_UICC_APPLICATIONS_ENABLEMENT_CHANGED 1053

#define RIL_UNSOL_BARRING_INFO 1054
#define RIL_UNSOL_REGISTRATION_FAILED 1055

#define RIL_UNSOL_RESPONSE_SIM_PHONEBOOK_CHANGED  1056
#define RIL_UNSOL_RESPONSE_SIM_PHONEBOOK_RECORDS_RECEIVED  1057

#define RIL_UNSOL_UNTHROTTLE_APN 1058

#define RIL_UNSOL_LINK_CAPACITY_ESTIMATE 1059

#define RIL_UNSOL_PHYSICAL_CHANNEL_CONFIG  1060

#define RIL_UNSOL_SLICING_CONFIG_CHANGED  1061

#define RIL_UNSOL_EMERGENCY_NETWORK_SCAN_RESULT 1062

#define RIL_UNSOL_TRIGGER_IMS_DEREGISTRATION 1063
#define RIL_UNSOL_NOTIFY_ANBR                1064
#define RIL_UNSOL_CONNECTION_SETUP_FAILURE   1065


/**
 * Indicates when there is a change in the IMEI with respect to the sim slot.
 */
#define RIL_UNSOL_IMEI_MAPPING_CHANGED 1066

#define RIL_UNSOL_CELLULAR_IDENTIFIER_DISCLOSED 1067
#define RIL_UNSOL_SECURITY_ALGORITHMS_UPDATED 1068
#define RIL_UNSOL_SIMULTANEOUS_CALLING_SUPPORT_CHANGED 1069
/***********************************************************************/
...
typedef void (*RIL_UpdateConnectiontState) (RIL_SOCKET_ID socketId, int isConnected, unsigned int clientType);
...
typedef enum {
    ...
    IPV4_TCP = 2,                /* TCP keepalive specified by RFC 1122 Section 4.2 */
    IPV4_UDP = 3,                /* UDP keepalive specified by RFC 1122 Section 4.1 */
    IPV6_TCP = 4,                /* TCP keepalive specified by RFC 1122 Section 4.2 */
    IPV6_UDP = 5                /* UDP keepalive specified by RFC 1122 Section 4.1*/
} RIL_KeepaliveType;
...
typedef struct {
    int maxBitrateKbps;         /** Maximum bit rate possible on the bearer */
    int guaranteedBitrateKbps;  /* Minimum bit rate that is guaranteed to be provided
                                 * by the network */
} RIL_QosBandwidth;

/** LTE/EPS Quality of Service parameters as per 3gpp spec 24.301 sec 9.9.4.3. */
typedef struct {
    int qci;   /* Quality of Service Class Identifier (QCI), see 3GPP TS 23.203 and 29.212.
...
typedef struct {
    int fiveQi; /* 5G QOS Identifier (5QI), see 3GPP TS 24.501 and 23.501.
                 * The allowed values are standard values(1-9, 65-68, 69-70, 75, 79-80, 82-85)
                 * defined in the spec and operator specific values in the range 128-254.*/
    RIL_QosBandwidth downlink;
    RIL_QosBandwidth uplink;
    int qfi;    /* QOS flow identifier of the QOS flow description in the
...
typedef struct {
    ...
    int typeOfService;          /*  safe_union TypeOfService {
                                         Monostate noinit;
                                         uint8_t value;
                                    } tos;
                                use -1 for noinit */
    ...
    long ipv6FlowLabel;         /* safe_union Ipv6FlowLabel {
                                         Monostate noinit;
                                         uint32_t value;
                                    } flowLabel;
                                 use -1 for noinit */
    ...
    long ipSecSpi;              /* safe_union IpsecSpi {
                                         Monostate noinit;
                                         uint32_t value;
                                    } spi;
                                 use -1 for noinit  */
...
typedef struct {
    int             qosSessionId;   /** Unique ID of the QoS session within the data call */
    RIL_Qos         qos;            /** QOS attributes */
    int             qosFilterCount;
    RIL_QosFilter   *qosFilters;    /** List of QOS filters associated with this session */
} RIL_QosSession;

/** Slice/Service Type as defined in 3GPP TS 23.501. */
typedef enum {
    NONE_TYPE = 0x0,      /* Not specified */
    EMBB      = 0x1,      /* Slice suitable for the handling of 5G enhanced Mobile Broadband */
    URLLC     = 0x2,      /* Slice suitable for the handling of ultra-reliable low latency
                           communications*/
    MIOT      = 0x3       /* Slice suitable for the handling of massive IoT*/
} RIL_SliceServiceType;

/** Slice status */
typedef enum {
    SLICE_UNKNOWN                            = 0x0, /* Unknow */
    SLICE_CONFIGURED                         = 0x1, /* Configured but not allowed or
                                                       rejected yet */
    SLICE_ALLOWED                            = 0x2, /* Allowed to be used */
    SLICE_REJECTED_NOT_AVAILABLE_IN_PLMN     = 0x3, /* Rejected because not available in PLMN */
    SLICE_REJECTED_NOT_AVAILABLE_IN_REG_AREA = 0x4, /* Rejected because not available in
                                                       reg area */
    SLICE_DEFAULT_CONFIGURED                 = 0x5  /* Considered valid when configured/allowed
                                                       slices are not available */
} RIL_SliceStatus;
...
typedef struct {
    RIL_SliceServiceType    sst;                /* The type of service provided by the slice
                                                   see: 3GPP TS 24.501 Section 9.11.2.8.*/
    int                     sliceDifferentiator;/* Slice differentiator is the identifier of a
                                                   slice that has SliceServiceType as SST.
                                                   A value of -1 indicates that there is no
                                                   corresponding SliceInfo of the HPLMN.
                                                   see: 3GPP TS 24.501 Section 9.11.2.8.*/
    RIL_SliceServiceType    mappedHplmnSst;     /* This SST corresponds to a SliceInfo (S-NSSAI)
                                                   of the HPLMN; the SST is mapped to this value.
                                                   see: 3GPP TS 24.501 Section 9.11.2.8.*/
    int                     mappedHplmnSD;      /* Present only if both sliceDifferentiator and
                                                   mappedHplmnSst are also present. This SD
                                                   corresponds to a SliceInfo (S-NSSAI) of the
                                                   HPLMN; sliceDifferentiator is mapped to this
                                                   value. A value of -1 indicates that there is
                                                   no corresponding SliceInfo of the HPLMN.
                                                   see: 3GPP TS 24.501 Section 9.11.2.8.*/
    RIL_SliceStatus             status;         /* Field to indicate the current status of the
                                                   slice. */
} RIL_SliceInfo;
...
typedef struct {
    ...
    char*                   domainDescriptors;
    char*                   connectionCapabilities;
...
typedef struct {
     ...
     * descriptor.
     */
    char dnn[RIL_MAX_DNN_COUNT][RIL_MAX_DNN_CHAR_COUNT + 1];
...
typedef struct {
     ...
     */
    RIL_TrafficDescriptor* trafficDescriptors;
    int rsdCount;
    /**
...
typedef struct {
    RIL_RadioAccessNetworks accessNetwork;  /* The access network to setup the data call.*/
    RIL_MtkDataProfileInfo  dataProfileInfo;
    int                     roamingAllowed;
    int                     reason;
    int                     pduSessionId;
    int                     sliceInfoValid;
    RIL_SliceInfo           sliceInfo;
    int                     tdValid;
    RIL_TrafficDescriptor   TD;
    bool                    matchAllRuleAllowed;
} RIL_SetupDataCallRequest;
...
typedef struct {
     ...
     */
    RIL_ModemInfo logicalModemList[MAX_SIM_COUNT];
} RIL_PhoneCapability;
...
#ifdef TBOX
    /**
     * MTK_RIL_ADAPTER: issue a local request
     */
    void (*IssueLocalRequest)(int request, void *data, int len, RIL_SOCKET_ID socket_id);
#endif //TBOX
};
