...
#ifndef __RMM_CAPABILITY_SWITCH_REQUEST_HANDLER_H__
#define __RMM_CAPABILITY_SWITCH_REQUEST_HANDLER_H__
...
class RmmCapabilitySwitchRequestHandler : public RfxBaseHandler {
    RFX_DECLARE_HANDLER_CLASS(RmmCapabilitySwitchRequestHandler);

  public:
    RmmCapabilitySwitchRequestHandler(int slot_id, int channel_id);
    virtual ~RmmCapabilitySwitchRequestHandler();
