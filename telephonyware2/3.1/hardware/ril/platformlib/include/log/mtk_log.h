...
#define RLOGD(...) (mtkLogD(LOG_TAG, __VA_ARGS__))
#define RLOGW(...) (mtkLogW(LOG_TAG, __VA_ARGS__))
#define RLOGE(...) (mtkLogE(LOG_TAG, __VA_ARGS__))
#define RLOGV(...) (mtkLogV(LOG_TAG, __VA_ARGS__))
#define RLOGI(...) (mtkLogI(LOG_TAG, __VA_ARGS__))
...
#undef MTK_LOG_ALWAYS_FATAL
#define MTK_LOG_ALWAYS_FATAL(...)               \
    do {                                        \
        mtkLogE(LOG_TAG, __VA_ARGS__);          \
        mtkAssert(NULL);                        \
        exit(0);                                \
