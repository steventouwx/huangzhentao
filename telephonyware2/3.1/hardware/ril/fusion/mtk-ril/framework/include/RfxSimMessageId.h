...
RFX_MSG_ID_EXPN(RFX_MSG_REQUEST_SIM_CLOSE_CHANNEL_WITH_SESSION)
...
RFX_MSG_ID_EXPN(RFX_MSG_REQUEST_GET_SIM_TYPE_INFO)
RFX_MSG_ID_EXPN(RFX_MSG_REQUEST_SWITCH_SIM_TYPE)
RFX_MSG_ID_EXPN(RFX_MSG_URC_RESPONSE_SIM_STATUS_CHANGED)
RFX_MSG_ID_EXPN(RFX_MSG_URC_SIM_COMMON_SLOT_NO_CHANGED)
RFX_MSG_ID_EXPN(RFX_MSG_URC_SIM_TYPE_INFO_IND)
...
RFX_MSG_ID_EXPN(RFX_MSG_EVENT_GET_MEP_SLOT_STATUS)
RFX_MSG_ID_EXPN(RFX_MSG_EVENT_GET_SIM_TYPE_INFO)
