...
/**
  ...
  @retval None
*/
typedef void (*ql_nw_ims_reg_status_ind_cb)(uint8_t ims_reg_status);
...
/**
  ...
  @retval None
*/
typedef void (*ql_nw_rf_band_info_ind_cb)(QL_NW_BAND_INFO_E rf_band);
...
/**
  ...
  @retval None
*/
typedef void (*ql_nw_lte_rach_fail_ind_cb)(ql_nw_lte_rach_fail_info_t *p_info);
...
/*-----------------------------------------------------------------------------------------------*/
/** 
  @brief This function scans the current network. The operation takes long time. In order not to affect the normal use of other functions, this function is called asynchronously and the scanning result can be processed in the second parameter (function pointer ql_nw_network_scan_async_cb()) of this function. 
...
/** 
  ...
  @param[in] lower_mode power mode,defined by QL_NW_LOWER_POWER_MASK_XXX
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_nw_get_power_mode(uint8_t *lower_mode);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_nw_set_ims_reg_status_ind_cb(ql_nw_ims_reg_status_ind_cb cb_func);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_nw_set_rf_band_info_ind_cb(ql_nw_rf_band_info_ind_cb cb_func);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_nw_set_lte_rach_fail_ind_cb(ql_nw_lte_rach_fail_ind_cb cb_func);
...
/** 
  ...
  @param[in] opt_mask Disable 5G service options. Currently, only QL_NW_NR5G_SO_NONE, QL_NW_NR5G_SO_NSA, and QL_NW_NR5G_SO_SA are supported. You can disable SA or NSA only, or disable both of them at the same time; or you can enable 5G feature by selecting QL_NW_NR5G_SO_NONE.
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_nw_get_ims_config(uint8_t* p_ims_enable);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_nw_set_ims_config(uint8_t ims_enable);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_nw_get_ims_config_ex(ql_nw_ims_config_ex_t* ims_config_ptr);
...
/** 
  ...
  */
/*-------------------------------------------------------------------------------------ss----------*/
int ql_nw_set_ims_config_ex(ql_nw_ims_config_ex_t ims_config);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_nw_get_ims_reg_status(uint8_t* ims_reg_status_ptr);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_nw_set_dlm_4rx_enable(uint8_t dlm_4rx_enable);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_nw_get_endc_config(ql_nw_get_endc_config_t* get_endc_config_ptr);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_nw_set_endc_config(ql_nw_set_endc_config_t set_endc_config);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_nw_set_deprioritize_nr5g_enable(uint8_t deprioritize_nr5g_enable);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_nw_trigger_wwan_reset(void);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_nw_get_drx(ql_nw_get_drx_t * get_drx_ptr);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_nw_set_drx(ql_nw_set_drx_t set_drx);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_nw_get_negotiated_drx(ql_nw_get_negotiated_drx_t * get_negotiated_drx_ptr);
