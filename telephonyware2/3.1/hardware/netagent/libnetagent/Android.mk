...
LOCAL_SHARED_LIBRARIES  := libc libmtkcutils libnetutils libmtkrillog liblog libcutils libmtkrilutils
...
LOCAL_HEADER_LIBRARIES += telephony_ril_include_headers

LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH) $(LOCAL_PATH)/na

include $(BUILD_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE:=libnetagent_includes
LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH) $(LOCAL_PATH)/na
