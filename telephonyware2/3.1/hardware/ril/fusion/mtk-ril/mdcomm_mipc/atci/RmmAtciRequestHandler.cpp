...
#include "RmmAtciRequestHandler.h"

/*****************************************************************************
 * Class RmmAtciRequestHandler
 *****************************************************************************/
//RFX_IMPLEMENT_HANDLER_CLASS(RmmAtciRequestHandler, RIL_CMD_PROXY_6);
RFX_REGISTER_DATA_TO_EVENT_ID(RfxStringData, RFX_MSG_EVENT_RAW_URC);

const char *RmmAtciRequestHandler::ERROR_RESPONSE = "\r\nERROR\r\n";
const char *RmmAtciRequestHandler::ENABLE_URC_PROP = "persist.vendor.service.atci_urc.enable";
const char *RmmAtciRequestHandler::LOG_TAG_ATCI = "RmmAtciRequestHandler";

RmmAtciRequestHandler::RmmAtciRequestHandler(int slot_id, int channel_id) :
        RfxBaseHandler(slot_id, channel_id) {
}

void RmmAtciRequestHandler::handleOemHookAtciInternalRequest(const sp<RfxMclMessage>& msg) {
...
void RmmAtciRequestHandler::handleMsgEventRawUrc(const sp<RfxMclMessage>& msg) {
