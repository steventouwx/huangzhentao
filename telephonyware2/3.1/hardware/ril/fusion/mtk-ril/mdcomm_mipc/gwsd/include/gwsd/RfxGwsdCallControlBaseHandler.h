...
class RfxGwsdCallControlBaseHandler {
    public:
        ...
        virtual void handleIcpgResultMessage(
                RfxBaseHandler* handler, const sp<RfxMclMessage>& msg, int slotId);
        virtual void handleCrfcpyIndicationMessage(
                RfxBaseHandler* handler, const sp<RfxMclMessage>& msg, int slotId);
        ...
        virtual void notifyDualSimGwsdImsIncomingCall(RfxController* controller, int callId);
        virtual void notifyDualSimGwsdImsIncomingCallChanged(RfxController* controller,
                int callId, bool isImsGwsd);
