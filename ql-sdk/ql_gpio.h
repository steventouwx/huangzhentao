...
/**
  ...
  */
/*****************************************************************/
int ql_gpio_set_awake(ENUM_PINNAME pin_name, ENUM_PIN_AWAKE en);
...
/**
  ...
  */
/******************************************************************/
int ql_gpio_get_awake(ENUM_PINNAME pin_name);
...
/**
  ...
  */
/*****************************************************************/
int ql_gpio_set_pull_selection(ENUM_PINNAME pin_name, ENUM_PIN_PULLSEL pullSel);
