 ...
 * Class SmsHeader
 *****************************************************************************/
class SmsHeader /*: public RfxObject*/ {
    // Required: declare this class
    //RFX_DECLARE_CLASS(SmsHeader);

public:
    SmsHeader();
    virtual ~SmsHeader();
    static SmsHeader* fromByteArray(BYTE* data, int headerLength/*, RfxObject *parent*/);
    static BYTE * toByteArray(SmsHeader* smsHeader);
