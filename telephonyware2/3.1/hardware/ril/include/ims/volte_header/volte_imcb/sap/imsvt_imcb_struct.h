...
#define INTERFACE_ID_MAGIC_CODE                         (0X1F1D0000)
...
typedef struct vt_srv_imcb_msg_setting {
    ...
    /**
         * INTERFACE_ID_MAGIC_CODE | <3-digit numbers>
         * landed after GEN98 because of Thin Modem products collocating with different AP platforms, where the if_name might differ
         *
         * e.g.
         *  interface_id = INTERFACE_ID_MAGIC_CODE | 503
         */
    imcf_uint32 interface_id;

     /* 178 - 6 = 172 */
    imcf_uint8 extension[172];
