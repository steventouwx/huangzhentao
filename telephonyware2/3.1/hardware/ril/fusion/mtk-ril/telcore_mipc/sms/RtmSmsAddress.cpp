 ...
 * RtmGsmSmsAddress
 *****************************************************************************/
RtmGsmSmsAddress::RtmGsmSmsAddress(unsigned char* data, int offset, int length) {
    if ((data != NULL) && (length > 0) && (length <= MAX_BUFFER_SIZE)) {
...
bool RtmGsmSmsAddress::bcd2Char(unsigned char bcd, String8 &addr) {
    if (bcd < 0xa) {
...
bool RtmGsmSmsAddress::calledPartyBCDFragmentToString(
 ...
 * RtmCdmaSmsAddress
 *****************************************************************************/
RtmCdmaSmsAddress::RtmCdmaSmsAddress(RIL_CDMA_SMS_Address &address) {
