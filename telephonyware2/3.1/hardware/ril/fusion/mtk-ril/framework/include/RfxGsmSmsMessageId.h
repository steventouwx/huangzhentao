...
RFX_MSG_ID_EXPN(RFX_MSG_URC_SMS_EINFO_EXTENSIONS)
...
RFX_MSG_ID_EXPN(RFX_MSG_REQUEST_SMS_ACKNOWLEDGE_TIMEOUT)
RFX_MSG_ID_EXPN(RFX_MSG_EVENT_SMS_DUP_DELAY)
RFX_MSG_ID_EXPN(RFX_MSG_EVENT_GSM_NEW_SMS_IND)
RFX_MSG_ID_EXPN(RFX_MSG_REQUEST_EXIT_SMS_SCBM)
RFX_MSG_ID_EXPN(RFX_MSG_URC_ENTER_SMS_SCBM)
RFX_MSG_ID_EXPN(RFX_MSG_URC_EXIT_SMS_SCBM)
