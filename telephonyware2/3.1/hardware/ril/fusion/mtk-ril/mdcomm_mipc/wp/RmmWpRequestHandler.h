...
#ifndef __RMM_WP_REQUEST_HANDLER_H__
#define __RMM_WP_REQUEST_HANDLER_H__
...
class RmmWpRequestHandler : public RfxBaseHandler {
    RFX_DECLARE_HANDLER_CLASS(RmmWpRequestHandler);

    public:
        RmmWpRequestHandler(int slot_id, int channel_id);
        virtual ~RmmWpRequestHandler();
...
#endif /*__RMM_WP_REQUEST_HANDLER_H__*/
