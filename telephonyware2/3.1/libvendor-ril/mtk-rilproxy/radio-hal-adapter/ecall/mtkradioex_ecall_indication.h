...
/* Callback class for mtkradioex ecall indication */
class MtkRadioExEcallIndication : public BnMtkRadioExEcallIndication {
public:
    MtkRadioExEcallIndication(int slot, RfxDispatchThread* dispatchThread);
 private:
  ...
  public:
    virtual ndk::ScopedAStatus ecallIndicationInd(::aidl::android::hardware::radio::RadioIndicationType in_type, const ::aidl::vendor::mediatek::hardware::mtkradioex::ecall::EcallMsg& in_ecallMsg) override;
};
