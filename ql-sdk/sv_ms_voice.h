 ...
 * 编写者:
 * 编写日期: 2026-03-05
 * 简要描述: 定义sv_ms_voice相关接口、数据结构及功能能力。
 * 修改记录:
 *******************************************/

#ifndef __SV_MS_VOICE_H__
#define __SV_MS_VOICE_H__
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_dial(int sim_id, char *num, int len, uint32_t *id);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_cancel_dial(int sim_id, uint32_t id);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_hangup_all(int sim_id);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_answer(int sim_id, uint32_t id);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_hangup(int sim_id, uint32_t id);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_hold(int sim_id, uint32_t id);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_unhold(int sim_id, uint32_t id);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_join_conference(int sim_id);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_leave_conference(int sim_id);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_get_records(int sim_id, sv_voice_record_array_t *p_arr);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_forwarding(int sim_id, int reg, SV_VOICE_FW_COND_E cond, char *num, int len);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_get_forwarding_status(int sim_id, SV_VOICE_FW_COND_E cond, sv_voice_fw_status_t *p_status);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_waiting(int sim_id, int enable);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_get_waiting_status(int sim_id, int *enabled);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_autoanswer(int sim_id, int enable, uint32_t sec);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_send_dtmf_char(int sim_id, uint32_t id, char c);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_set_call_cb(int sim_id, sv_ms_voice_call_cb_f cb);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_set_dtmf_cb(int sim_id, sv_ms_voice_dtmf_cb_f cb);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_ecall_dial(int sim_id, sv_voice_ecall_info_t *p_info);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_ecall_hangup(int sim_id);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_ecall_update_msd(int sim_id, const uint8_t *msd, uint32_t msd_len);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_ecall_push_msd(int sim_id, SV_VOICE_ECALL_STATE_E *state);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_ecall_get_config(int sim_id, sv_voice_ecall_config_t *p_config);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_ecall_set_config(int sim_id, int item, sv_voice_ecall_config_t *p_config);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_ecall_set_event_cb(int sim_id, sv_ms_voice_ecall_event_cb_f cb);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_ecall_set_status_cb(int sim_id, sv_ms_voice_ecall_status_cb_f cb);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_set_service_error_cb(sv_voice_service_error_cb_f cb);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_send_ussd(int sim_id, sv_voice_ussd_info_t *pt_ussd);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_cancel_ussd(int sim_id);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_set_recv_ussd_cb(int sim_id,sv_ms_voice_ussd_cb_f cb);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_set_white_list_enable(int sim_id, uint8_t enable);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_get_white_list_enable(int sim_id, uint8_t *enable_ptr);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_set_white_list_add_num(int sim_id, char *num_ptr, int len);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_set_white_list_del_num(int sim_id, char *num_ptr, int len);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_set_white_list_del_all(int sim_id);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_voice_get_white_list_all(int sim_id, sv_voice_white_list_info_t *info_ptr);
