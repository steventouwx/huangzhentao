...
#ifndef __RTM_CDMA_SMS_CONTROLLER_H__
#define __RTM_CDMA_SMS_CONTROLLER_H__
...
class RtmCdmaSmsController : public RfxController {
RFX_DECLARE_CLASS(RtmCdmaSmsController);

public:
    RtmCdmaSmsController();
    virtual ~RtmCdmaSmsController();
...
private:
    ...
    const char *TAG = "RtmCdmaSmsController";
};
#endif /* __RTM_CDMA_SMS_CONTROLLER_H__ */
