...
public:
    ...
    void setType(RFX_MESSAGE_TYPE msgType) {
        m_type = msgType;
    }
    int getId() const {
        return m_id;
    ...
    RfxMipcData* getMipcData() const {
        return m_mipc_data;
    }
    void setMipcData(RfxMipcData* data) {
        m_mipc_data = data;
    }
    ...
    int getMclToken() const {
        return m_mcl_token;
    }
    void setMclToken(int mclToken) {
        m_mcl_token = mclToken;
    }
    ...
    nsecs_t getMipcAsyncTimeStamp() const {
        return mMipcAsynTimeStamp;
    }

    void setMipcAsyncTimeStamp(nsecs_t timeStamp) {
        mMipcAsynTimeStamp = timeStamp;
    }
    ...
    public:
        ...
        static sp<RfxMclMessage> obtainMipcUrc(RfxMipcData* data);

        static sp<RfxMclMessage> obtainMipcCmd(RfxMipcData* data);
        ...
        static int generateMclToken();
        static void resetToken();

private:
    static pthread_mutex_t mcl_token_mutex;
    static int mclTokenCounter;
