...
class RilpAtciSocket : public RfxObject {

    RFX_DECLARE_CLASS(RilpAtciSocket);
    RFX_OBJ_DECLARE_SINGLETON_CLASS(RilpAtciSocket);
    ...
    */
    ...
    public:
        ...
        * @param Socket name.
        */
        RilpAtciSocket(const char* socketName) {
            name = socketName;
        }
         ...
         */
        static void initSocket(const char *socketName);
        //static RilpAtciSocket* getInstance();
        int getAtciRilSocket();
    private:
        friend void *::ril_atci_socket_reader_looper(void *arg);

    private:
        //static RilpAtciSocket* s_instance;
        /**
         * connect to socket
         */
        void connectSocket(void);
        ...
        /**
         * bypass raw data from atci socket to Rilproxsy.
         */
        void process_raw_data(void *pRecord);
};
