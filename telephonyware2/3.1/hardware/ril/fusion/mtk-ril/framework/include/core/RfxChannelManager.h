...
#else
#define RIL_TTY_CHANNEL_IMS "/dev/wwanD0VTS"
#endif

#define IMS_FD_USELESS (-999)
...
class RfxChannelManager {
    ...
    public:
        ...
        static void init();
        static sp<RfxSender> getSender(int channelId);
        ...
        static const char* getMuxPath(int proxyId);
        static void initImsFd(int channel_id, int imsFd);
