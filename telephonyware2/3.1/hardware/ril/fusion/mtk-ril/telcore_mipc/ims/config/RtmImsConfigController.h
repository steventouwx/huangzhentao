...
/*****************************************************************************
 * Class RtmImsConfigController
 *****************************************************************************/
class RtmImsConfigController : public RfxController {
    RFX_DECLARE_CLASS(RtmImsConfigController);  // Required: declare this class


public:
    RtmImsConfigController(){};
    virtual ~RtmImsConfigController(){};
...
private:
    ...
    void setVoNREnable(const sp<RfxMessage> &message);
    void isVoNREnabled(const sp < RfxMessage > & message);
    ...
    void triggerVodataCfgCommand(int slot_id);
    void triggerImsAddCapabilityCommand(int value);
    void triggerImsCfgCommand(int slot_id);
    void triggerImsDisableCommand(int slot_id);
...
private:
    ...
    std::map<int, int> mVoDataFeatureValue;         // <Network Id, Feature Value>
    std::map<int, int> mCallComposerFeatureValue;   // <Network Id, Feature Value>
