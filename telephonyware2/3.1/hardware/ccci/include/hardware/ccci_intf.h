...
#define CCCI_IOC_SMEM_POLL_EXIT          _IO(CCCI_IOC_MAGIC, 76) /* for ccb poll exit */
...
#define CCCI_IOC_RILD_POWER_OFF_MD    _IO(CCCI_IOC_MAGIC, 125) /* RILD notify ccci power off md */
...
#define CCCI_FS_IOC_SEND_MSG      _IOR(CCCI_FS_IOC_MAGIC, 3, unsigned int)
