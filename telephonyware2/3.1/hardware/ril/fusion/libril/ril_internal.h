...
// For RatSwitch
#define MTK_SMART_RAT_SWITCH_RIL_SERVICE_NAME_BASE "mtkSmartRatSwitch"
#define MTK_SMART_RAT_SWITCH_RIL1_SERVICE_NAME "mtkSmartRatSwitch1"
#define MTK_SMART_RAT_SWITCH_RIL2_SERVICE_NAME "mtkSmartRatSwitch2"
#define MTK_SMART_RAT_SWITCH_RIL3_SERVICE_NAME "mtkSmartRatSwitch3"
#define MTK_SMART_RAT_SWITCH_RIL4_SERVICE_NAME "mtkSmartRatSwitch4"

// For RatSwitch
#define MTK_RSU_RIL_SERVICE_NAME_BASE "mtkRsu"
#define MTK_RSU_RIL1_SERVICE_NAME "mtkRsu1"
#define MTK_RSU_RIL2_SERVICE_NAME "mtkRsu2"
#define MTK_RSU_RIL3_SERVICE_NAME "mtkRsu3"
#define MTK_RSU_RIL4_SERVICE_NAME "mtkRsu4"

// For Data Channel
#define MTK_DCH_RIL_SERVICE_NAME_BASE "mtkDch"
#define MTK_DCH_RIL1_SERVICE_NAME "mtkDch1"
#define MTK_DCH_RIL2_SERVICE_NAME "mtkDch2"
#define MTK_DCH_RIL3_SERVICE_NAME "mtkDch3"
#define MTK_DCH_RIL4_SERVICE_NAME "mtkDch4"
...
typedef unsigned int ClientType;
...
typedef struct CommandInfo {
    int requestNumber;
    int(*responseFunction) (unsigned int slotId, ClientId clientId, int responseType, int token,
...
typedef struct {
    int requestNumber;
    int (*responseFunction) (unsigned int slotId, int responseType, int token,
            RIL_Errno e, const void *response, size_t responselen);
    WakeType wakeType;
} UnsolResponseInfo;

extern "C" RequestInfo * addRequestToList(int serial, int slotId, int request);
