...
class RmcDcImsDataChannel2ReqHandler : public RfxBaseHandler {
    ...
    private:
        ...
        int isEncrypted = 0;
        // 1:ims act,2:ims act done, 3:ims deact,4:eims act,5:eims act done, 6:eims deact
        typedef enum {
            RFX_ONGOING_IMS_PDN_ACT = 1,
            RFX_ONGOING_IMS_PDN_ACT_DONE = 2,
            RFX_ONGOING_IMS_PDN_DEACT = 3,
            RFX_ONGOING_EIMS_PDN_ACT = 4,
            RFX_ONGOING_EIMS_PDN_ACT_DONE = 5,
            RFX_ONGOING_EIMS_PDN_DEACT = 6
        } ImsOrEimsPdnStatus;
        int imsPdnState = 0;
        int eImsPdnState = 0;
};
