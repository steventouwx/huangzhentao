 ...
 */
#ifndef __RMM_CDMA_SMS_CONVERTER_H__
#define __RMM_CDMA_SMS_CONVERTER_H__
/*****************************************************************************
 * Include
 *****************************************************************************/
#include "RfxObject.h"
 ...
 * RmmTlvNode
 *****************************************************************************/
class RmmTlvNode: public RfxObject {
    RFX_DECLARE_CLASS(RmmTlvNode);
...
public:
    // Default Constructor
    RmmTlvNode() : m_tag(-1), m_length(-1), m_error(0) {
    }
 ...
 * TeleServiceId
 *****************************************************************************/
class TeleServiceId : public RmmTlvNode{
 ...
 * ServiceCategory
 *****************************************************************************/
class ServiceCategory : public RmmTlvNode{
 ...
 * CdmaSmsAddress
 *****************************************************************************/
class CdmaSmsAddress : public RmmTlvNode{
 ...
 * CdmaSmsSubAddress
 *****************************************************************************/
class CdmaSmsSubAddress : public RmmTlvNode {
 ...
 * BearerReplyOpt
 *****************************************************************************/
class BearerReplyOpt: public RmmTlvNode {
 ...
 * CauseCode
 *****************************************************************************/
class CauseCode: public RmmTlvNode {
 ...
 * BearerData
 *****************************************************************************/
class BearerData : public RmmTlvNode{
...
public:
    ...
    static void hexStringToBytes(const char *in, int inLength, char *out,
        int outLength);
};


#endif /* __RMM_CDMA_SMS_CONVERTER_H__ */
