...
#ifndef __RMM_DC_UTILITY_H__
#define __RMM_DC_UTILITY_H__
...
#define ACT_CALL_REQ_TIMEOUT                ((uint32_t)900000)  // 15 * 60 * 1000
#define DEACT_CALL_REQ_TIMEOUT              ((uint32_t)900000)  // 15 * 60 * 1000
#define GET_CALL_REQ_TIMEOUT                ((uint32_t)900000)  // 15 * 60 * 1000
#define GET_MD_DATA_CALL_LIST_REQ_TIMEOUT   ((uint32_t)900000)  // 15 * 60 * 1000
...
class RmmDcUtility {
    public:
        ...
        static int getMipcApnTypeId(const int profileType);
        ...
        static int getMipcProtocolType(const char* protocol);
        ...
        static bool isRcsSupportPcscf();
        static bool isUserBuild();
        static int isFastDormancySupport();
        static int getMipcApnType(int rilApnType);
        ...
        static int byteToHexStr(const char* byteArr, int arrLen, char *hexStr, int hexStrLen);
        static vector<string> splitString(string str, string delim);
        static vector<string> nonCompressedColonSepIpV6ToVector(char* input);
        static vector<string> compressedColonSepIpV6ToVector(char* input);
        static vector<string> colonSepIpV6ToVector(char* input);
        static vector<string> dotSepIpV6ToVector(char* input);
        static vector<string> ipV6ToVector(char* input);
        static vector<string> ipV4ToVector(char* input);
        static int convertFailCauseToRilStandard(int cause, int slodId);
        static bool isVerizonOnSiteLteSimCard(int slotId);
};
#endif /* __RMM_DC_UTILITY_H__ */
