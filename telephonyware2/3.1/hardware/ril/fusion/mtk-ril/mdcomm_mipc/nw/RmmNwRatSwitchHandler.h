...
class RmmNwRatSwitchHandler : public RmmNwHandler {
    ...
    private:
        ...
        void handleSetAllowedNetworkTypeRequest(const sp<RfxMclMessage>& msg);

        void handleGetAllowedNetworkTypeRequest(const sp<RfxMclMessage>& msg);
        void handleGetAllowedNetworkTypeResponse(const sp<RfxMclMessage>& msg);

        void handleAbortPlmnListQuery(const sp<RfxMclMessage>& msg);
