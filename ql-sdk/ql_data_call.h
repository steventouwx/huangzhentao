...
/**
  ...
  @retval QL_ERR_OK - Not enough memory
  @retval QL_ERR_INVALID_ARG - Invalid arguments
  */
/*-----------------------------------------------------------------------------------------------*/
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_data_call_reset_pkt_stats(int call_id);
...
/// @private
/*-----------------------------------------------------------------------------------------------*/
int ql_data_call_bind_subscription(QL_NET_BIND_SUBSCRIPTION_E subs);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_data_call_go_dormant(int timer_interval, int send_scri, int call_id);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_data_call_get_bit_rate(int call_id, ql_data_call_bit_rate_t *p_rate);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_data_call_set_data_filter_mode(int call_id, int mode, int auto_exit);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_data_call_get_data_filter_mode(int call_id, int *mode);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_data_call_add_data_filter(int call_id, ql_data_call_data_filter_t *p_info);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_data_call_remove_all_data_filter(int call_id);
