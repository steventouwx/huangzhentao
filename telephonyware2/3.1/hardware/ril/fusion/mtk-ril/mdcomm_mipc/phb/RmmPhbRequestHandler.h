...
#ifndef __RMM_PHB_REQUEST_HANDLER_H__
#define __RMM_PHB_REQUEST_HANDLER_H__
...
class RmmPhbRequestHandler : public RfxBaseHandler {
    RFX_DECLARE_HANDLER_CLASS(RmmPhbRequestHandler);

    public:
        RmmPhbRequestHandler(int slot_id, int channel_id);
        virtual ~RmmPhbRequestHandler();
