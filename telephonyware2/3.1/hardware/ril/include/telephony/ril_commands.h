...
*/
    ...
    {RIL_REQUEST_SET_NETWORK_SELECTION_MANUAL_WITH_RAN, radio::setNetworkSelectionModeManualResponse},
    ...
    {RIL_REQUEST_SET_NRDC_STATE, radio::setNrDualConnectivityStateResponse},
    {RIL_REQUEST_GET_NRDC_STATE, radio::isNrDualConnectivityEnabledResponse},
    ...
    {RIL_REQUEST_ENTER_SIM_DEPERSONALIZATION, radio::supplySimDepersonalizationResponse},
    ...
    {RIL_REQUEST_ARE_UICC_APPLICATIONS_ENABLED, radio::areUiccApplicationsEnabledResponse},
    ...
    {RIL_REQUEST_GET_BARRINGINFO, radio::getBarringInfoResponse},
    ...
    {RIL_REQUEST_SET_MODEM_CONFIG, radioConfig::setModemsConfigResponse},
    ...
    {RIL_REQUEST_GET_SLICING_CONFIG, radio::getSlicingConfigResponse},
...
#define RIL_CMD_PROXY_11    RIL_CMD_11
  ...
  #define RIL_CHANNEL_7 RIL_CMD_PROXY_1
    ...
    //eCall
//#ifdef ECALL_SUPPORT
    { RIL_REQUEST_ECALL_FAST_MAKE_ECALL,dispatchFastEcall,responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
    { RIL_REQUEST_ECALL_SET_IVS,dispatchInts,responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
    { RIL_REQUEST_ECALL_SET_MSD,dispatchSetMsd,responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
    { RIL_REQUEST_ECALL_SET_PSAP,dispatchInts,responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
    { RIL_REQUEST_ECALL_IVS_PUSH_MSD,dispatchVoid,responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
    { RIL_REQUEST_ECALL_PSAP_PULL_MSD,dispatchVoid,responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
    { RIL_REQUEST_ECALL_SET_TEST_NUM,dispatchEcallRecord,responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
    { RIL_REQUEST_ECALL_SET_RECONF_NUM,dispatchEcallRecord,responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
    { RIL_REQUEST_ECALL_MAKE_ECALL,dispatchInts,responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
    { RIL_REQUEST_ECALL_RESET_IVS,dispatchVoid,responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
    { RIL_REQUEST_ECALL_CTRL_SEQUENCE,dispatchStrings,responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
    { RIL_REQUEST_ECALL_SET_PRI,dispatchInts,responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
    { RIL_REQUEST_ECALL_SET_NAD_DEREGISTRATION_TIME,dispatchInts,responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
    { RIL_REQUEST_ECALL_SET_REGISTRATION_STATE,dispatchInts,responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
    { RIL_REQUEST_ECALL_SET_OPRT_MODE, dispatchInts, responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
    { RIL_REQUEST_ECALL_GET_OPRT_MODE, dispatchVoid, responseInts, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
//#endif /*ECALL_SUPPORT*/
    ...
    {RIL_REQUEST_VOICE_REGISTRATION_STATE, dispatchVoid, responseVoiceRegState, RIL_CMD_PROXY_3, RIL_CHANNEL_3},
    {RIL_REQUEST_DATA_REGISTRATION_STATE, dispatchVoid, responseDataRegState, RIL_CMD_PROXY_3, RIL_CHANNEL_3},
    ...
    {RIL_REQUEST_EXPLICIT_CALL_TRANSFER, dispatchVoid, responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
    ...
    //{RIL_REQUEST_SET_CARRIER_RESTRICTIONS, dispatchCarrierRestrictions, responseInts, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
    //{RIL_REQUEST_GET_CARRIER_RESTRICTIONS, dispatchVoid, responseCarrierRestrictions, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
    ...
    {RIL_REQUEST_GET_SLOT_STATUS, dispatchVoid, responseVoid, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
    {RIL_REQUEST_SET_LOGICAL_TO_PHYSICAL_SLOT_MAPPING, dispatchVoid, responseVoid, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
    {RIL_REQUEST_START_KEEPALIVE, dispatchVoid, responseKeepaliveStatus, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
    {RIL_REQUEST_STOP_KEEPALIVE, dispatchVoid, responseVoid, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
    {RIL_REQUEST_SET_SIGNAL_STRENGTH_REPORTING_CRITERIA, dispatchVoid, responseVoid, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
...
//#endif /*ECALL_SUPPORT*/
    ...
    {RIL_REQUEST_SET_PREFERRED_NETWORK_TYPE, dispatchInts, responseVoid, RIL_CMD_PROXY_1, RIL_CHANNEL_3},
    {RIL_REQUEST_GET_PREFERRED_NETWORK_TYPE, dispatchVoid, responseInts, RIL_CMD_PROXY_1, RIL_CHANNEL_3},
    {RIL_REQUEST_SET_ALLOWED_NETWORK_TYPES_BITMAP, dispatchInts, responseVoid, RIL_CMD_PROXY_1, RIL_CHANNEL_3},
    {RIL_REQUEST_GET_ALLOWED_NETWORK_TYPES_BITMAP, dispatchVoid, responseInts, RIL_CMD_PROXY_1, RIL_CHANNEL_3},
    {RIL_REQUEST_SET_LOCATION_UPDATES, dispatchInts, responseVoid, RIL_CMD_PROXY_3, RIL_CHANNEL_3},
    {RIL_REQUEST_CDMA_SET_SUBSCRIPTION_SOURCE, dispatchInts, responseVoid, RIL_CMD_PROXY_3, RIL_CHANNEL_3},
    {RIL_REQUEST_CDMA_SET_ROAMING_PREFERENCE, dispatchInts, responseVoid, RIL_CMD_PROXY_3, RIL_CHANNEL_3},
    {RIL_REQUEST_CDMA_QUERY_ROAMING_PREFERENCE, dispatchVoid, responseInts, RIL_CMD_PROXY_3, RIL_CHANNEL_3},
    ...
    {RIL_REQUEST_CDMA_VALIDATE_AND_WRITE_AKEY, dispatchString, responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_2},
    {RIL_REQUEST_CDMA_SEND_SMS, dispatchCdmaSms, responseSMS, RIL_CMD_PROXY_1, RIL_CHANNEL_5},
    {RIL_REQUEST_CDMA_SEND_SMS_EXPECT_MORE, dispatchCdmaSms, responseSMS, RIL_CMD_PROXY_1, RIL_CHANNEL_5},
    {RIL_REQUEST_CDMA_SMS_ACKNOWLEDGE, dispatchCdmaSmsAck, responseVoid, RIL_CMD_PROXY_1, RIL_CHANNEL_5},
    {RIL_REQUEST_GSM_GET_BROADCAST_SMS_CONFIG, dispatchVoid, responseGsmBrSmsCnf, RIL_CMD_PROXY_2, RIL_CHANNEL_5},
    {RIL_REQUEST_GSM_SET_BROADCAST_SMS_CONFIG, dispatchGsmBrSmsCnf, responseVoid, RIL_CMD_PROXY_1, RIL_CHANNEL_5},
    {RIL_REQUEST_GSM_SMS_BROADCAST_ACTIVATION, dispatchInts, responseVoid, RIL_CMD_PROXY_1, RIL_CHANNEL_5},
    ...
    {RIL_REQUEST_SIM_OPEN_CHANNEL, dispatchOpenChannelParams, responseInts, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
    {RIL_REQUEST_SIM_CLOSE_CHANNEL, dispatchInts, responseVoid, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
    {RIL_REQUEST_SIM_CLOSE_CHANNEL_WITH_SESSION, dispatchInts, responseVoid, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
    {RIL_REQUEST_SIM_TRANSMIT_APDU_CHANNEL, dispatchSIM_APDU, responseSIM_IO, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
    {RIL_REQUEST_NV_READ_ITEM, dispatchNVReadItem, responseString, RIL_CMD_PROXY_3, RIL_CHANNEL_1},
    {RIL_REQUEST_NV_WRITE_ITEM, dispatchNVWriteItem, responseVoid, RIL_CMD_PROXY_3, RIL_CHANNEL_1},
    {RIL_REQUEST_NV_WRITE_CDMA_PRL, dispatchRaw, responseVoid, RIL_CMD_PROXY_3, RIL_CHANNEL_1},
    ...
    {RIL_REQUEST_ENTER_SIM_DEPERSONALIZATION, dispatchStrings, responseInts, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
    {RIL_REQUEST_SEND_DEVICE_STATE, dispatchInts, responseVoid, RIL_CMD_PROXY_3, RIL_CHANNEL_3},
    {RIL_REQUEST_SET_UNSOLICITED_RESPONSE_FILTER, dispatchInts, responseVoid, RIL_CMD_PROXY_3, RIL_CHANNEL_3},
    {RIL_REQUEST_SET_SIM_CARD_POWER, dispatchInts, responseVoid, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
    {RIL_REQUEST_ENABLE_UICC_APPLICATIONS, dispatchInts, responseVoid, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
    {RIL_REQUEST_ARE_UICC_APPLICATIONS_ENABLED, dispatchVoid, responseInts, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
    {RIL_REQUEST_START_NETWORK_SCAN, dispatchNetworkScan, responseVoid, RIL_CMD_PROXY_3, RIL_CHANNEL_3},
    {RIL_REQUEST_STOP_NETWORK_SCAN, dispatchVoid, responseVoid, RIL_CMD_PROXY_3, RIL_CHANNEL_3},
    ...
    {RIL_REQUEST_SET_MODEM_CONFIG, dispatchInts, responseVoid, RIL_CMD_PROXY_1, RIL_CHANNEL_3}
#endif /* MTK_USE_HIDL */
