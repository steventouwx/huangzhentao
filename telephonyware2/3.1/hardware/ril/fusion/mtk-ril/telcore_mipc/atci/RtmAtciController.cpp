...
#include "RtmAtciController.h"
#include "ctype.h"
#include "rfx_properties.h"

/*****************************************************************************
 * Class RtmAtciController
 *****************************************************************************/
...
RFX_IMPLEMENT_CLASS("RtmAtciController", RtmAtciController, RfxController);

const char *RtmAtciController::LOG_TAG_ATCI = "RtmAtciController";
const char *RtmAtciController::ENABLE_URC_PROP = "persist.vendor.service.atci_urc.enable";
const char *RtmAtciController::FRAMEWORK_COMMANDS[] = {
    "AT%FLIGHT",
    "AT%DIAL",
    "AT%CONFERENCE",
    "AT%VILTEUPGRADE",
...
RtmAtciController::RtmAtciController() :
    mIsWaitingMessageInput(false) {
}

void RtmAtciController::onInit() {
...
bool RtmAtciController::onHandleAtciRequest(const sp<RfxMessage>& message) {
...
bool RtmAtciController::onHandleAtciResponse(const sp<RfxMessage>& message) {
    int messageId = message->getId();
    char *data = NULL;
    logD(LOG_TAG_ATCI, "[%s] message: %d %s", __FUNCTION__, messageId, idToString(messageId));
    switch (messageId) {
...
bool RtmAtciController::handleSpecialRequest(const sp<RfxMessage>& message, String8& command) {
