...
#define RFX_LOG_TAG "RtcVsim"

RFX_IMPLEMENT_CLASS("RtcVsimController", RtcVsimController, RfxController);


/*****************************************************************************
 * Class RtcVsimController
 *****************************************************************************/
RtcVsimController::RtcVsimController() {
    logD(RFX_LOG_TAG, "RtcVsimController construct,slot:%d", m_slot_id);
}

RtcVsimController::~RtcVsimController() {
}

void RtcVsimController::onInit() {
...
bool RtcVsimController::onCheckIfRejectMessage(
...
bool RtcVsimController::onHandleRequest(const sp<RfxMessage>& msg) {
...
bool RtcVsimController::onHandleResponse(const sp<RfxMessage>& msg) {
    int msg_id = msg->getId();
