...
-------------------------------------------------------------------------------------------------*/
#ifndef __QL_AUDIO_PCM_H__
#define __QL_AUDIO_PCM_H__
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
void ql_audio_playback_state_ind_cb_set(ql_audio_playback_state_cb_f cb, void *params);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
ql_audio_handle_t ql_audio_playback_open(QL_AUDIO_FE_PCM_DEV_E fe_pcm, uint32_t be_dai_mask);

/*-----------------------------------------------------------------------------------------------*/
/**
  @brief  This function prepares for audio file playback.

  @param[in] hdl  The handle returned by ql_audio_playback_open().
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_playback_file_prepare(ql_audio_handle_t hdl,
...
/**
  ...
  @param[in] hdl  The API ql_audio_playback_open return results
  @param[in] pcm_config  Pcm config, including sample rate, channel nums,
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_playback_stream_prepare(ql_audio_handle_t hdl,
                                     ql_audio_pcm_config_t *p_config,
                                     ql_audio_playback_state_cb_f state_cb,
                                     void *params);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_playback_play(ql_audio_handle_t hdl);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_playback_buffer_size_get(ql_audio_handle_t hdl, uint32_t *p_size);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_playback_push_stream(ql_audio_handle_t hdl, void *buffer, uint32_t size);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_playback_stop(ql_audio_handle_t hdl);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_playback_close(ql_audio_handle_t hdl);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_playback_pause(ql_audio_handle_t hdl);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_playback_resume(ql_audio_handle_t hdl);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
void ql_audio_playback_get_state(ql_audio_handle_t hdl, QL_AUDIO_PLAYBACK_STATE_E *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_playback_set_block_flag(ql_audio_handle_t hdl, uint8_t flags);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
void ql_audio_capture_state_ind_cb_set(ql_audio_capture_state_cb_f cb, void *params);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
ql_audio_handle_t ql_audio_capture_open(QL_AUDIO_FE_PCM_DEV_E fe_pcm, uint32_t be_dai_mask);

/*-----------------------------------------------------------------------------------------------*/
/**
  @brief This function prepares for audio file capturing.

  @param[in] hdl  The handle returned by ql_audio_capture_open().
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_capture_file_prepare(ql_audio_handle_t hdl,
                                  const char *file_name,
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_capture_stream_prepare(ql_audio_handle_t hdl,
                                    ql_audio_pcm_config_t *p_config,
                                    ql_audio_capture_state_cb_f state_cb,
                                    void *params);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_capture_record(ql_audio_handle_t hdl);
...
/**
  ...
  @note  This function should be called after ql_audio_capture_stream_prepare
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_capture_buffer_size_get(ql_audio_handle_t hdl, uint32_t *p_size);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_capture_pull_stream(ql_audio_handle_t hdl, void *buffer, uint32_t size);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_capture_stop(ql_audio_handle_t hdl);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_capture_close(ql_audio_handle_t hdl);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_capture_pause(ql_audio_handle_t hdl);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_capture_resume(ql_audio_handle_t hdl);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
void ql_audio_capture_get_state(ql_audio_handle_t hdl, QL_AUDIO_CAPTURE_STATE_E *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_decode_amrFile_to_wavFile(const char *amr_file_name, const char *wav_file_name);
