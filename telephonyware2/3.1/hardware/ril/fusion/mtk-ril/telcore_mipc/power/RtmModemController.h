...
#ifndef __RTM_MODEM_CONTROLLER_H__
#define __RTM_MODEM_CONTROLLER_H__
...
class RtmModemController : public RfxController {
    RFX_DECLARE_CLASS(RtmModemController); // Required: declare this class

public:

    RtmModemController();
    virtual ~RtmModemController();
