...
private:
    ...
    RfxStatusManager *m_status_managers[RFX_SLOT_COUNT + 1]; // add one more status manage for no-slot controllers
    RfxController *m_slot_root_controllers[RFX_SLOT_COUNT + 1]; // add one more for append non-slot controllers
