 ...
 * 编写者:
 * 编写日期: 2026-03-05
 * 简要描述: 定义sv_audio_cfg相关接口、数据结构及功能能力。
 * 修改记录:
 *******************************************/
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_loopback_enable_state(int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_loopback_enable_state(int32_t *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_loopback_enable_state_ex(SV_AUDIO_LOOPBACK_STREAM_TYPE_E type, int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_loopback_enable_state_ex(SV_AUDIO_LOOPBACK_STREAM_TYPE_E type, int32_t *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_tone_enable_state(int32_t state, sv_audio_tone_config_t *p_config);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_tone_enable_state(int32_t *p_state);
...
ringtones and voice stream status control. range: SV_AUDIO_STATE_0 and SV_AUDIO_STATE_1
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_voice_call_manager_state(int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_voice_call_manager_state(int32_t *p_state);
...
sv_audio_set_voice_call_manager_state(), the service program sv_audiod will not enable voice stream
while establishing a voice call. In such a case, call sv_audio_set_voice_stream_state() to enable voice
...
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_voice_stream_state(int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_voice_stream_state(int32_t *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_tx_voice_mic_gain(int32_t gain);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_tx_voice_mic_gain(int32_t *p_gain);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_tx_voice_vol(int32_t volume);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_tx_voice_vol(int32_t *p_volume);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_tx_voice_mute_state(int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_tx_voice_mute_state(int32_t *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_rx_voice_spkr_gain(int32_t gain);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_rx_voice_spkr_gain(int32_t *p_gain);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_rx_voice_vol_step(int32_t volume_step);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_rx_voice_vol_step(int32_t *p_volume_step);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_rx_voice_mute_state(int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_rx_voice_mute_state(int32_t *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_audio_tx_mic_gain(int32_t gain);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_audio_tx_mic_gain(int32_t *p_gain);
...
int sv_audio_set_audio_rx_codec_gain(int32_t gain);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_audio_rx_codec_gain(int32_t *p_gain);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_codec_up_vol(int32_t volume);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_codec_up_vol(int32_t *p_volume);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_codec_down_vol(int32_t volume);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_codec_down_vol(int32_t *p_volume);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_codec_mic_mute_state(int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_codec_mic_mute_state(int32_t *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_codec_spk_mute_state(int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_codec_spk_mute_state(int32_t *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_mixer_control(const char *ctl_name, const char *ctl_values);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_mixer_control(const char *ctl_name, char *values, uint32_t size);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_acdb_device_mode(SV_AUDIO_ACDB_DEV_MODE_E mode);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_acdb_device_mode(SV_AUDIO_ACDB_DEV_MODE_E *p_mode);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_sample_rate(int32_t sample_rate);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_sample_rate(int32_t *p_sample_rate);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_uac_enable_state(int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_uac_enable_state(int32_t *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_sidetone_gain(int32_t gain);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_get_sidetone_gain(int32_t *p_gain);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_audio_set_service_error_cb(sv_audio_service_error_cb_f cb);
