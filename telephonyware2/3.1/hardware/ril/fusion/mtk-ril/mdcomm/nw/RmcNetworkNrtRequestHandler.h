...
class RmcNetworkNrtRequestHandler : public RmcNetworkHandler {
    ...
    private:
        ...
        int simulateNetowrkScanByCOPS(RIL_NetworkScanResult* result);
        int simulateNetowrkScanByEXOPL(RIL_NetworkScanResult* result);
        bool handleSimulatedNetworkScanResultByRat();
        bool handleSimulatedNetworkScanResultByRat(int rat);
