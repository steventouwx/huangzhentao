 ...
 *****************************************************************************/
class RmcDcReqHandler : public RfxBaseHandler, public NetObject {
    ...
    public:
        void handleKernelAddressUpdatedCallback(bool bSuccess, void *data);
    ...
    private:
        ...
        void handleNwAct(const sp<RfxMclMessage>& msg);
        void handleNwDeact(const sp<RfxMclMessage>& msg);
        ...
        void handleKernelAddressUpdated(const sp<RfxMclMessage>& msg);
        void handleUrspReevaluate(const sp<RfxMclMessage>& msg);
        void handleUpdateDataRatRequest(const sp<RfxMclMessage>& msg);
        void handleAttachApnChanged(const sp<RfxMclMessage>& msg);
        void handleReleaseRfOccupy(const sp<RfxMclMessage>& msg);
        void handleReleaseRfOccupyTimeout(const sp<RfxMclMessage>& msg);
