...
static int responseEcallStatus(RIL_RequestFunc onRequest, Parcel &p, void *response, size_t responselen);
...
extern int responseGetSystemSelectionChannels(Parcel &p, void *response, size_t responselen);
