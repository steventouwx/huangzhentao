 ...
 * 编写者:
 * 编写日期: 2026-03-05
 * 简要描述: 定义sv_ms_sim相关接口、数据结构及功能能力。
 * 修改记录:
 *******************************************/
 ...
 * @return no value
 */
typedef void (*sv_ms_sim_card_status_cb_f)(int sim_id, sv_sim_card_info_t *p_info);
 ...
 * @return no value
 */
typedef void (*sv_ms_sim_card_refresh_cb_f)(int sim_id, sv_sim_refresh_info_t* p_info);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_get_imsi(int sim_id, SV_SIM_APP_TYPE_E app_type, char *imsi, int imsi_len);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_get_iccid(int sim_id, char *iccid, int iccid_len);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_get_phone_num(int sim_id, SV_SIM_APP_TYPE_E app_type, 
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_get_operators(int sim_id, sv_sim_operator_list_t *list);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_enable_pin(int sim_id, SV_SIM_APP_TYPE_E app_type, 
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_disable_pin(int sim_id, SV_SIM_APP_TYPE_E app_type, 
                             SV_SIM_PIN_E pin, const char *pin_value);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_verify_pin(int sim_id, SV_SIM_APP_TYPE_E app_type, 
                             SV_SIM_PIN_E pin, const char *pin_value);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_change_pin(int sim_id, SV_SIM_APP_TYPE_E app_type, 
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_unblock_pin(int sim_id, SV_SIM_APP_TYPE_E app_type, 
...
/**
  ...
  @param [in] sim_id sim_id to be used.
  @param [out] p_info Pointer of sv_ms_sim_card_info_t.
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_get_card_info(int sim_id, sv_sim_card_info_t *p_info);
...
/**
  ...
  @param [in] sim_id sim_id to be used.
  @param [in] app_type Application type.
  @param [inout] p_file Pointer of sv_ms_sim_file_t.
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_read_file(int sim_id, SV_SIM_APP_TYPE_E app_type, sv_sim_file_t *p_file);
...
/**
  ...
  @param [in] sim_id sim_id to be used.
  @param [in] app_type Application type.
  @param [in] p_file Pointer of sv_ms_sim_file_t
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_write_file(int sim_id, SV_SIM_APP_TYPE_E app_type, sv_sim_file_t *p_file);
...
/**
  ...
  @param [in] sim_id sim_id to be used.
  @param [in] app_type Application type.
  @param [inout] p_info Pointer of sv_ms_sim_file_info_t.
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_get_file_info(int sim_id, SV_SIM_APP_TYPE_E app_type, 
...
/**
  ...
  @param [out] p_record Pointer of sv_ms_sim_phone_book_record_t.
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_read_phone_book(int sim_id, SV_SIM_APP_TYPE_E app_type,
...
/**
  ...
  @param [in] p_record Pointer of sv_ms_sim_phone_book_record_t.
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_write_phone_book(int sim_id, SV_SIM_APP_TYPE_E app_type, 
                                    const char *pb_path, uint8_t record_idx,
                                    sv_sim_phone_book_record_t *p_record);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_open_logical_channel(int sim_id, uint8_t *channel_id);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_close_logical_channel(int sim_id, uint8_t channel_id);
...
/**
  ...
  @param [inout] p_apdu Pointer of sv_ms_sim_apdu_t.
  @note You must call sv_ms_sim_open_logical_channel before sending an APDU.
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_send_apdu(int sim_id, uint8_t channel_id, sv_sim_apdu_t *p_apdu);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_set_card_status_cb(int sim_id, sv_ms_sim_card_status_cb_f cb);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_set_card_refresh_cb(int sim_id, sv_ms_sim_card_refresh_cb_f cb);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_set_sim_slot_active(SV_SIM_SLOT_E slot, uint8_t active);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_get_sim_slot_active(SV_SIM_SLOT_E slot, uint8_t *p_active);
/*-----------------------------------------------------------------------------------------------*/
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_set_service_error_cb(sv_sim_service_error_cb_f cb);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_ms_sim_get_eid(int sim_id, char *eid, int eid_len);
