 ...
 */
#ifndef __RTM_SMS_ADDRESS_H__
#define __RTM_SMS_ADDRESS_H__
/*****************************************************************************
 * Include
 *****************************************************************************/
 ...
 * RtmGsmSmsAddress
 *****************************************************************************/
class RtmGsmSmsAddress: public RtmSmsAddress {
// Constructor / Destructor
public:
    // Constructor
    RtmGsmSmsAddress(unsigned char* data, int offset, int length);
 ...
 * RtmCdmaSmsAddress
 *****************************************************************************/
class RtmCdmaSmsAddress: public RtmSmsAddress {
// Constructor / Destructor
public:
    RtmCdmaSmsAddress(RIL_CDMA_SMS_Address &addr);
};
#endif /* __RTM_SMS_ADDRESS_H__ */