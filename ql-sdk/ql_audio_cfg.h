...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_loopback_enable_state(int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_loopback_enable_state(int32_t *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_loopback_enable_state_ex(QL_AUDIO_LOOPBACK_STREAM_TYPE_E type, int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_loopback_enable_state_ex(QL_AUDIO_LOOPBACK_STREAM_TYPE_E type, int32_t *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_tone_enable_state(int32_t state, ql_audio_tone_config_t *p_config);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_tone_enable_state(int32_t *p_state);
...
ringtones and voice stream status control. range: QL_AUDIO_STATE_0 and QL_AUDIO_STATE_1
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_voice_call_manager_state(int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_voice_call_manager_state(int32_t *p_state);
...
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_voice_stream_state(int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_voice_stream_state(int32_t *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_tx_voice_mic_gain(int32_t gain);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_tx_voice_mic_gain(int32_t *p_gain);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_tx_voice_vol(int32_t volume);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_tx_voice_vol(int32_t *p_volume);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_tx_voice_mute_state(int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_tx_voice_mute_state(int32_t *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_rx_voice_spkr_gain(int32_t gain);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_rx_voice_spkr_gain(int32_t *p_gain);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_rx_voice_vol_step(int32_t volume_step);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_rx_voice_vol_step(int32_t *p_volume_step);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_rx_voice_mute_state(int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_rx_voice_mute_state(int32_t *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_audio_tx_mic_gain(int32_t gain);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_audio_tx_mic_gain(int32_t *p_gain);
...
int ql_audio_set_audio_rx_codec_gain(int32_t gain);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_audio_rx_codec_gain(int32_t *p_gain);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_codec_up_vol(int32_t volume);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_codec_up_vol(int32_t *p_volume);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_codec_down_vol(int32_t volume);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_codec_down_vol(int32_t *p_volume);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_codec_mic_mute_state(int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_codec_mic_mute_state(int32_t *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_codec_spk_mute_state(int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_codec_spk_mute_state(int32_t *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_mixer_control(const char *ctl_name, const char *ctl_values);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_mixer_control(const char *ctl_name, char *values, uint32_t size);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_acdb_device_mode(QL_AUDIO_ACDB_DEV_MODE_E mode);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_acdb_device_mode(QL_AUDIO_ACDB_DEV_MODE_E *p_mode);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_sample_rate(int32_t sample_rate);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_sample_rate(int32_t *p_sample_rate);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_uac_enable_state(int32_t state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_uac_enable_state(int32_t *p_state);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_set_sidetone_gain(int32_t gain);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_audio_get_sidetone_gain(int32_t *p_gain);
