...
#ifndef __RMM_PHB_IN_MODEM_HANDLER_H__
#define __RMM_PHB_IN_MODEM_HANDLER_H__
...
#define RFX_LOG_TAG "RmmPhbInModem"
...
class RmmPhbInModemHandler : public RfxBaseHandler {
    RFX_DECLARE_HANDLER_CLASS(RmmPhbInModemHandler);

    public:
        RmmPhbInModemHandler(int slot_id, int channel_id);
        virtual ~RmmPhbInModemHandler();
    ...
    protected:
        ...
        mipc_phb_stroage_type_const_enum getPhbStorageType(int type);
        mipc_phb_ef_file_type_const_enum convertToMipcPhbEfFileType(int type);
        RIL_Errno mipcResultToRilResult(unsigned int result);
