...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_sms_set_white_list_enable(int sim_id, uint8_t enable);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_sms_get_white_list_enable(int sim_id, uint8_t *enable_ptr);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_sms_set_white_list_add_num(int sim_id, char *num_ptr, int len);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_sms_set_white_list_del_num(int sim_id, char *num_ptr, int len);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_sms_set_white_list_del_all(int sim_id);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_sms_get_white_list_all(int sim_id, ql_sms_white_list_info_t *info_ptr);
