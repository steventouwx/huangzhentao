...
#ifndef __RTM_VSIM_CONTROLLER_H__
#define __RTM_VSIM_CONTROLLER_H__
...
class RtmVsimController : public RfxController {
RFX_DECLARE_CLASS(RtmVsimController);

public:
    RtmVsimController();
    virtual ~RtmVsimController();
...
#endif /* __RTM_VSIM_CONTROLLER_H__ */
