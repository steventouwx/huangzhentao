...
#ifndef __RMM_GSM_SMS_BASE_HANDLER_H__
#define __RMM_GSM_SMS_BASE_HANDLER_H__
...
class RmmGsmSmsBaseHandler : public RfxBaseHandler {
RFX_DECLARE_HANDLER_CLASS(RmmGsmSmsBaseHandler);

public:
    RmmGsmSmsBaseHandler(int slot_id, int channel_id);
...
#endif /* __RMM_GSM_SMS_BASE_HANDLER_H__ */
