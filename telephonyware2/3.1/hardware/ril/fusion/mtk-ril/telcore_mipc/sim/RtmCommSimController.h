...
#ifndef __RTM_COMM_SIM_CONTROLLER_H__
#define __RTM_COMM_SIM_CONTROLLER_H__
...
class RtmCommSimController : public RfxController {
RFX_DECLARE_CLASS(RtmCommSimController);

public:
    RtmCommSimController();
    virtual ~RtmCommSimController();
...
protected:
    ...
    // For pending the sequential request RFX_MSG_REQUEST_ENABLE_UICC_APPLICATIONS
...
private:
    ...
    bool isEnableUiccApplicationsProcessing();

    void handleEnableUiccApplications(const sp<RfxMessage>& msg);

    void handleEnableUiccApplicationsResponse(const sp<RfxMessage>& msg);

    bool isSwitchSimTypeProcessing();
    bool isEnableUiccApplicationsProcessingInAnySlots();
    void handlSwitchSimType(const sp<RfxMessage>& msg);
    void handlSwitchSimTypeResponse(const sp<RfxMessage>& msg);
    void handleSimTypeInfoChanged(const sp<RfxMessage>& msg);

    void handleUiccApplicationsEnablementChanged(const sp<RfxMessage>& msg);
...
private:
    ...
    sp<RfxMessage> mCacheUAEMsg;
    int mSimIoCount;
};
#endif /* __RTM_COMM_SIM_CONTROLLER_H__ */
