...
*/
    ...
    {RIL_UNSOL_UICC_APPLICATIONS_ENABLEMENT_CHANGED, radio::uiccApplicationsEnablementChanged, WAKE_PARTIAL},
    ...
    {RIL_UNSOL_BARRING_INFO, radio::onBarringInfoInd, WAKE_PARTIAL},
    {RIL_UNSOL_REGISTRATION_FAILED, radio::onRegistrationFailedInd, WAKE_PARTIAL},
    {RIL_UNSOL_RESPONSE_SIM_PHONEBOOK_CHANGED, radio::simPhonebookChanged, WAKE_PARTIAL},
    {RIL_UNSOL_RESPONSE_SIM_PHONEBOOK_RECORDS_RECEIVED, radio::simPhonebookRecordsReceived, WAKE_PARTIAL},
    {RIL_UNSOL_LINK_CAPACITY_ESTIMATE, radio::currentLinkCapacityEstimate, WAKE_PARTIAL},
    {RIL_UNSOL_PHYSICAL_CHANNEL_CONFIG, radio::currentPhysicalChannelConfigs, WAKE_PARTIAL},
    ...
    {RIL_UNSOL_CARRIER_INFO_IMSI_ENCRYPTION, responseVoid, WAKE_PARTIAL},
    ...
    {RIL_UNSOL_RESPONSE_IMS_NETWORK_STATE_CHANGED, responseVoid, WAKE_PARTIAL},
    {RIL_UNSOL_UICC_SUBSCRIPTION_STATUS_CHANGED, responseInts, WAKE_PARTIAL},
    {RIL_UNSOL_UICC_APPLICATIONS_ENABLEMENT_CHANGED, responseInts, WAKE_PARTIAL},
    {RIL_UNSOL_SRVCC_STATE_NOTIFY, responseInts, WAKE_PARTIAL},
    {RIL_UNSOL_HARDWARE_CONFIG_CHANGED, responseHardwareConfig, WAKE_PARTIAL},
    {RIL_UNSOL_DC_RT_INFO_CHANGED, responseDcRtInfo, WAKE_PARTIAL},
    {RIL_UNSOL_RADIO_CAPABILITY, responseRadioCapability, WAKE_PARTIAL},
