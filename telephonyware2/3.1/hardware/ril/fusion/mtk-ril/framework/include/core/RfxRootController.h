...
public:
    ...
    RfxStatusManager *getStatusManager(unsigned int slot_id) const;

    RfxController *getSlotRootController(unsigned int slot_id) const;

    void setSlotRootController(unsigned int slot_id, RfxController *slot_root);
