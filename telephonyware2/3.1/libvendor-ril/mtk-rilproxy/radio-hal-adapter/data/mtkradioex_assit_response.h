...
class MtkRadioExAssistResponse : public BnAssistRadioResponse {
public:
    MtkRadioExAssistResponse(int slot, RfxDispatchThread* dispatchThread);
 private:
  ...
  public:
    ...
    virtual ndk::ScopedAStatus setFdModeResponse(const ::aidl::android::hardware::radio::RadioResponseInfo& in_info) override;
