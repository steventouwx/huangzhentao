...
public:
    static void printfLog(const char* tag, const char* debug, const char* fmt, va_list args);
...
#define SLOGE(...) logutils::SLOG::E(LOG_TAGE, ##__VA_ARGS__)
