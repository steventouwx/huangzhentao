...
/*****************************************************************************
 * Class RtmCapabilitySwitchUtil
 *****************************************************************************/
int RtmCapabilitySwitchUtil::getRafFromNetworkType(int type) {
    int raf;
...
int RtmCapabilitySwitchUtil::getAdjustedRaf(int raf) {
...
int RtmCapabilitySwitchUtil::getNetworkTypeFromRaf(int raf) {
    int type;
    int adj_raf;
    ...
    switch (adj_raf) {
        ...
        case (RAF_TD_SCDMA):
            ...
            break;
        case (RAF_TD_SCDMA | RAF_WCDMA_GROUP):
            type = PREF_NET_TYPE_TD_SCDMA_WCDMA;
            break;
        case (RAF_TD_SCDMA | RAF_LTE_GROUP):
            type = PREF_NET_TYPE_TD_SCDMA_LTE;
            break;
        case (RAF_GSM_GROUP | RAF_TD_SCDMA):
            type = PREF_NET_TYPE_TD_SCDMA_GSM;
            break;
        case (RAF_TD_SCDMA | RAF_GSM_GROUP | RAF_LTE_GROUP):
            type = PREF_NET_TYPE_TD_SCDMA_GSM_LTE;
            break;
        case (RAF_WCDMA_GROUP | RAF_TD_SCDMA | RAF_GSM_GROUP):
            type = PREF_NET_TYPE_TD_SCDMA_GSM_WCDMA;
            break;
        case (RAF_LTE_GROUP | RAF_TD_SCDMA | RAF_WCDMA_GROUP):
            type = PREF_NET_TYPE_TD_SCDMA_WCDMA_LTE;
            break;
        case (RAF_LTE_GROUP | RAF_TD_SCDMA | RAF_GSM_GROUP | RAF_WCDMA_GROUP):
            type = PREF_NET_TYPE_TD_SCDMA_GSM_WCDMA_LTE;
            break;
        case (RAF_TD_SCDMA | RAF_CDMA_GROUP | RAF_EVDO_GROUP | RAF_GSM_GROUP | RAF_WCDMA_GROUP):
            type = PREF_NET_TYPE_TD_SCDMA_GSM_WCDMA_CDMA_EVDO_AUTO;
            break;
        case (RAF_LTE_GROUP | RAF_TD_SCDMA | RAF_CDMA_GROUP | RAF_EVDO_GROUP | RAF_GSM_GROUP | RAF_WCDMA_GROUP):
...
bool RtmCapabilitySwitchUtil::isDisableC2kCapability() {
...
bool RtmCapabilitySwitchUtil::isDssNoResetSupport() {
    char tmp[RFX_PROPERTY_VALUE_MAX] = { 0 };
...
bool RtmCapabilitySwitchUtil::isOp01Sim(const String8& imsi) {
...
bool RtmCapabilitySwitchUtil::isOp02Sim(const String8& imsi) {
...
bool RtmCapabilitySwitchUtil::isOp09Sim(const String8& imsi) {
...
bool RtmCapabilitySwitchUtil::isOp18Sim(const String8& imsi) {
...
bool RtmCapabilitySwitchUtil::isHvolteSupport() {
...
bool RtmCapabilitySwitchUtil::isSimSwitchEnabled() {
    ...
    if (strcmp(property_value, "0") == 0) {
        RFX_LOG_I(RFX_LOG_TAG, "sim switch is disabled by EM");
        return false;
    }
    return true;
}
