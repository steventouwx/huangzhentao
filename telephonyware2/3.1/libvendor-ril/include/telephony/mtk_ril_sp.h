...
#include <../include/telephony/mtk_ril_embms_def.h>
#include <stdbool.h>
...
#define RIL_REQUEST_GET_NITZ (RIL_REQUEST_VENDOR_BASE + 238)
#define RIL_REQUEST_GET_IMSCFG (RIL_REQUEST_VENDOR_BASE + 239)
...
#ifdef TBOX
#define RIL_UNSOL_DUMMY (RIL_UNSOL_VENDOR_BASE + 48)
#endif
