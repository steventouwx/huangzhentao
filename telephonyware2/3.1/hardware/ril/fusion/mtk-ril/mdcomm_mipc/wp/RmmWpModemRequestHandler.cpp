...
#include "RmmWpModemRequestHandler.h"
...
RFX_IMPLEMENT_HANDLER_CLASS(RmmWpModemRequestHandler, RIL_CMD_PROXY_9);

RmmWpModemRequestHandler::RmmWpModemRequestHandler(int slot_id, int channel_id):RfxBaseHandler(slot_id, channel_id) {
    const int request[] = {
...
RmmWpModemRequestHandler::~RmmWpModemRequestHandler() {
}

void RmmWpModemRequestHandler::onHandleRequest(const sp<RfxMclMessage>& msg) {
...
void RmmWpModemRequestHandler::requestModifyModem(const sp<RfxMclMessage>& msg) {
...
void RmmWpModemRequestHandler::requestStoreModem(const sp<RfxMclMessage>& msg) {
    int *pInt = (int *)msg->getData()->getData();
...
void RmmWpModemRequestHandler::requestReloadModem(const sp<RfxMclMessage>& msg) {
    int *pInt = (int *)msg->getData()->getData();
