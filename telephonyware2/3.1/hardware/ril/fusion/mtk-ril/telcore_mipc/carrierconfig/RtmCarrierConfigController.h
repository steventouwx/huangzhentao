...
class RtmCarrierConfigController : public RfxController {
    // Required: declare this class
    RFX_DECLARE_CLASS(RtmCarrierConfigController);

public:
    RtmCarrierConfigController();
    virtual ~RtmCarrierConfigController();
