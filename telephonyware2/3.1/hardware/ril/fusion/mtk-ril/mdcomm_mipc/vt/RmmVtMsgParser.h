...
#ifndef __RMM_VT_MSG_PARSER_H__
#define __RMM_VT_MSG_PARSER_H__
...
const int MSG_ID_WRAP_IMSVT_RILD_BEGIN                          = MSG_ID_WRAP_IMSVT_IMCB_BEGIN + 1500;
const int MSG_ID_WRAP_IMSVT_RILD_VTSERVICE_STATUS               = MSG_ID_WRAP_IMSVT_RILD_BEGIN + 1;
const int MSG_ID_WRAP_IMSVT_RILD_RILD_STATUS                    = MSG_ID_WRAP_IMSVT_RILD_BEGIN + 2;
const int MSG_ID_WRAP_IMSVT_RILD_GET_OP_ID_REQ                  = MSG_ID_WRAP_IMSVT_RILD_BEGIN + 3;
const int MSG_ID_WRAP_IMSVT_RILD_GET_OP_ID_RSP                  = MSG_ID_WRAP_IMSVT_RILD_BEGIN + 4;
...
#define VT_RIL_STATUS_IND                           vt_srv_ril_msg_status_struct

#define VT_GET_OP_ID_REQ                            vt_srv_ril_msg_operator_struct
#define VT_GET_OP_ID_RSP                            vt_srv_ril_msg_operator_struct

class RmmVtMsgParser {

    private:
        RmmVtMsgParser();

    public:
        virtual ~RmmVtMsgParser();

        static RmmVtMsgParser* getInstance();
        void startSession(char* input, int type);
        void stopSession();
        int getSlot();

        static RmmVtMsgParser          *s_RmmVtMsgParser;
    ...
    private:
        ...
        VT_STATUS_REQ           *mServiceStatusStruct;
        VT_RIL_STATUS_IND       *mRildStatusStruct;
        VT_GET_OP_ID_REQ        *mGetOpIdReqStruct;
};

#endif /* __RMM_MSIM_REQ_HANDLER_H__ */
