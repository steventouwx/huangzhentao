 ...
 * 编写者:
 * 编写日期: 2026-03-05
 * 简要描述: 定义sv_data_call相关接口、数据结构及功能能力。
 * 修改记录:
 *******************************************/
...
#ifndef __SV_DATA_CALL_H__
#define __SV_DATA_CALL_H__
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_create(int call_id, const char *call_name, int is_background);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
sv_data_call_param_t *sv_data_call_param_alloc(void);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_param_init(sv_data_call_param_t *param);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_param_set_apn_id(sv_data_call_param_t *param, int apn_id);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_param_set_apn_name(sv_data_call_param_t *param, const char *apn_name);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_param_get_apn_name(sv_data_call_param_t *param, char *buf, int buf_len);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_param_set_user_name(sv_data_call_param_t *param, const char *user_name);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_param_get_user_name(sv_data_call_param_t *param, char *buf, int buf_len);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_param_set_user_password(sv_data_call_param_t *param, const char *user_password);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_param_set_auth_pref(sv_data_call_param_t *param, int auth_pref);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_param_set_ip_version(sv_data_call_param_t *param, int ip_ver);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_param_get_ip_version(sv_data_call_param_t *param, int *p_ver);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_param_set_reconnect_mode(sv_data_call_param_t *param, int reconnect_mode);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_param_get_reconnect_mode(sv_data_call_param_t *param, int *p_mode);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_param_set_reconnect_interval(sv_data_call_param_t *param, int *time_list, int num);
...
/**
  ...
  @param[in,out] p_num
  @return Whether the data call get auto reconnection interval successfully
  @retval SV_ERR_OK - Successful
  @retval SV_ERR_INVALID_ARG - Invalid arguments
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_param_get_reconnect_interval(sv_data_call_param_t *param, int *time_list, int *p_num);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_config(int call_id, sv_data_call_param_t *param);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_get_config(int call_id, sv_data_call_param_t *param);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_start(int call_id);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_stop(int call_id);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_delete(int call_id);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_get_list(sv_data_call_item_t *list, int *list_len);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_get_status(int call_id, sv_data_call_status_t *p_sta);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_get_pkt_stats(int call_id, sv_data_call_pkt_stats_t *p_sta);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_reset_pkt_stats(int call_id);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_set_status_ind_cb(sv_data_call_status_ind_cb_f cb);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_set_apn_config(int apn_id, sv_data_call_apn_config_t *p_info);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_set_service_error_cb(sv_data_call_service_error_cb_f cb);
...
/// @private
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_bind_subscription(SV_NET_BIND_SUBSCRIPTION_E subs);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_go_dormant(int timer_interval, int send_scri, int call_id);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_get_bit_rate(int call_id, sv_data_call_bit_rate_t *p_rate);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_set_data_filter_mode(int call_id, int mode, int auto_exit);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_get_data_filter_mode(int call_id, int *mode);
...
/**
  ...
  @return Whether add data filter successfully
  @retval SV_ERR_OK - successful
  @retval SV_ERR_NOT_INIT - uninitialized
  @retval SV_ERR_SERVICE_NOT_READY - service is not ready
  @retval SV_ERR_INVALID_ARG - Invalid arguments
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_add_data_filter(int call_id, sv_data_call_data_filter_t *p_info);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int sv_data_call_remove_all_data_filter(int call_id);
