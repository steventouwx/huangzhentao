...
#ifndef __RTM_OP_IMS_CONTROLLER_H__
#define __RTM_OP_IMS_CONTROLLER_H__
...
class RtmOpImsController : public RfxController {
    // Required: declare this class
    RFX_DECLARE_CLASS(RtmOpImsController);

public:
    RtmOpImsController();
    virtual ~RtmOpImsController();
...
#endif /* __RTM_OP_IMS_CONTROLLER_H__ */
