...
class RmcSuppServUssdDomainSelector : public RmcSuppServUssdBaseHandler {
    ...
    private:
        ...
        /**
         * A few operators e.g. Airtel allow UE to send USSI but it comes another USSD session
         * after USSI session is ended. USSI session is just a medium.
         * In order to deal this kind of case, USSI is supported but needs to reply in USSD,
         * we need a flag to do domain selection.
         */
        bool mNeedUserReply;
