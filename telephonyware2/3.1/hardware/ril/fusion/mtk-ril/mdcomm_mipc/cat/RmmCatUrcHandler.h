...
#ifndef __RMM_CAT_URC_HANDLER_H__
#define __RMM_CAT_URC_HANDLER_H__

#define LOG_TAG "RmmCatUrcHandler"
...
class RmmCatUrcHandler : public RfxBaseHandler {
    RFX_DECLARE_HANDLER_CLASS(RmmCatUrcHandler);

    public:
        RmmCatUrcHandler(int slot_id, int channel_id);
        virtual ~RmmCatUrcHandler();
    ...
    private:
        ...
        void handleStkInd(const sp<RfxMclMessage>& msg);
        void handleStkSimRefreshInd(const sp<RfxMclMessage>& msg);
