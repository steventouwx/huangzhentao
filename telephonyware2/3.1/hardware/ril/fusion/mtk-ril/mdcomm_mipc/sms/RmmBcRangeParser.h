 ...
 */
#ifndef __RMM_BC_RANGE_PARSER_H__
#define __RMM_BC_RANGE_PARSER_H__
/*****************************************************************************
 * Include
 *****************************************************************************/
 ...
 * supported by MD
 */
#define MAX_SINGLE_RANGE_NUM    60
#define MAX_RANGE_NUM    30
#define MAX_RANGE    (MAX_SINGLE_RANGE_NUM + MAX_RANGE_NUM)
...
class RmmBcRangeParser {
public:
    static int getRangeFromString(char *cateogry, Range *r);
...
#endif /* __RMM_CDMA_BC_RANGE_PARSER_H__ */
