...
static int Ipv4GetMacByIoctl(const char *ipStr, const char *ifname, struct sockaddr *WlanSocketAddr);
...
static int SendNewNeighborMessage(int fd, const char *ipStr, int ifIndex, bool is_ipv6, struct sockaddr *WlanSocketAddr);
