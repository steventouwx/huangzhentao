...
#ifndef __RTM_CAPABILITY_SWITCH_CONTROLLER_H__
#define __RTM_CAPABILITY_SWITCH_CONTROLLER_H__
 ...
 *****************************************************************************/
class RtmCapabilitySwitchController : public RfxController {
    // Required: declare this class
    RFX_DECLARE_CLASS(RtmCapabilitySwitchController);

  public:
    RtmCapabilitySwitchController();
    virtual ~RtmCapabilitySwitchController();
...
// Override
  ...
  private:
    ...
    // void powerOnRadio();
    void onRildInitDone(RfxStatusKeyEnum key, RfxVariant old_value, RfxVariant new_value);
  ...
  private:
    ...
    RtmCapabilitySwitchChecker* m_checker_controller;
};

#endif /* __RTM_CAPABILITY_SWITCH_CONTROLLER_H__ */
