...
#ifndef __RMM_VT_DATA_THREAD_CONTROLLER_H__
#define __RMM_VT_DATA_THREAD_CONTROLLER_H__
...
/*****************************************************************************
 * Class RmmVtReqHandlerSharedMemory
 *****************************************************************************/
class RmmVtSharedMemory: virtual public RefBase {

    public:
        RmmVtSharedMemory(void);
        virtual ~RmmVtSharedMemory();
...
/*****************************************************************************
 * Class RmmVtDataThreadController
 *****************************************************************************/
class RmmVtDataThreadController: virtual public RefBase {

    public:
        RmmVtDataThreadController(void);
        virtual ~RmmVtDataThreadController();

        void start();

        static void *RIL_IMCB_THREAD(void *arg);
        static void *VT_RIL_THREAD(void *arg);
        static sp<RmmVtSharedMemory> getSharedMem(void);
    ...
    private:
        ...
        static sp<RmmVtSharedMemory> sShareMemmory;
