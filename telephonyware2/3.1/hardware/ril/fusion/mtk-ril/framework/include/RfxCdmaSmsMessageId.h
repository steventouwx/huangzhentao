...
RFX_MSG_ID_EXPN(RFX_MSG_EVENT_CDMA_NEW_SMS_CMD)
RFX_MSG_ID_EXPN(RFX_MSG_REQUEST_CDMA_SEND_SMS)
RFX_MSG_ID_EXPN(RFX_MSG_REQUEST_CDMA_SEND_SMS_EXPECT_MORE)
...
RFX_MSG_ID_EXPN(RFX_MSG_REQUEST_CDMA_SMS_ACKNOWLEDGE_TIMEOUT)
