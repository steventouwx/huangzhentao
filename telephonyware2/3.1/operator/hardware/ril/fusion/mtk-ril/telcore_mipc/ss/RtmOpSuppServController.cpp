...
#define RFX_LOG_TAG "RtmOpSuppServController"
/*****************************************************************************
 * Class RfxController
 *****************************************************************************/

RFX_IMPLEMENT_CLASS("RtmOpSuppServController", RtmOpSuppServController, RfxController);

RtmOpSuppServController::RtmOpSuppServController() {
}

RtmOpSuppServController::~RtmOpSuppServController() {
}

void RtmOpSuppServController::onInit() {
...
bool RtmOpSuppServController::onHandleRequest(const sp<RfxMessage>& message) {
    requestToMcl(message);
    return true;
}

bool RtmOpSuppServController::onHandleUrc(const sp<RfxMessage>& message) {
    return responseToRilj(message);
}

bool RtmOpSuppServController::onHandleResponse(const sp<RfxMessage>& message) {
    return responseToRilj(message);
}

bool RtmOpSuppServController::onCheckIfRejectMessage(const sp<RfxMessage>& message,
