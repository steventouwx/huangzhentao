...
int totalUrc;
int currUrcCount;
RIL_PhysicalChannelConfig* phyChlCfgInfo;
} PHY_CHL_CFG_URC_CACHE;
...
class RmcNetworkUrcHandler : public RmcNetworkHandler {
    ...
    private:
        ...
        void handleLegacyNitzTzReceived(const sp<RfxMclMessage>& msg);
        ...
        void handleVoLteEmergencySupportedChanged(const sp<RfxMclMessage>& msg);
        void handleVoNrEmergencySupportedChanged(const sp<RfxMclMessage>& msg);
        void handleCellularQualityReport(const sp<RfxMclMessage>& msg);
        void handleConnectionStateReport(const sp<RfxMclMessage>& msg);
        void handleEnhancedMccMncChanged(const sp<RfxMclMessage>& msg);
        void handleCaInfoChanged(const sp<RfxMclMessage>& msg);
        void handleBarringInfoReport(const sp<RfxMclMessage>& msg);
        void handleEcampuiChanged(const sp<RfxMclMessage>& msg);
        void handleEndcCapabilityChanged(const sp<RfxMclMessage>& msg);
        void handleChInfoChanged(const sp<RfxMclMessage>& msg);
        void handleNrCaBandChanged(const sp<RfxMclMessage>& msg);
...
protected:
        ...
        bool receivedEcampUI;
        PHY_CHL_CFG_URC_CACHE* mPccUrcCache = NULL;
};
