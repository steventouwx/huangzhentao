...
/*****************************************************************************
 * Class NetPostInvoke1 (Indication)
 *****************************************************************************/
class NetPostInvoke1 : public NetBase {
    public:
        typedef void (NetObject::*ObjMemFunc1)(bool bSuccess, void *data);

    public:
        template <class _MemFunc>
        NetPostInvoke1(NetObject *obj, _MemFunc func) :
            NetBase(obj, (NetObjMemFuncPtr)static_cast<ObjMemFunc1>(func)) {
        }
        virtual ~NetPostInvoke1() {
        }
};
...
/*****************************************************************************
 * Class NetActionBase1 (Indication)
 *****************************************************************************/
class NetActionBase1 : public virtual RefBase {
    public:
        virtual void ack1(bool bSuccess = true, void *data = NULL) = 0;

    public:
        NetActionBase1() {
        }
        virtual ~NetActionBase1() {
        }
};
...
/*****************************************************************************
 * Class NetAction1 (Indication)
 *****************************************************************************/
class NetAction1 : public virtual NetActionBase1 {
    public:
        template <class _MemFunc>
        NetAction1(
                NetObject *obj, // [IN] the callback object
    ...
    public:
        virtual void ack1(bool bSuccess = true, void *data = NULL) {
            callback1(bSuccess, data);
        }

    private:
        void callback1(bool bSuccess, void *data) {
            typedef NetPostInvoke1 PostInvoke;
            NetObject *obj = m_invoke.m_obj_ptr;
            if (obj != NULL) {
                typename PostInvoke::ObjMemFunc1 memFunc =
                        (typename PostInvoke::ObjMemFunc1)m_invoke.m_callback;
                (obj->*memFunc)(bSuccess, data);
            }
        }

    private:
        NetPostInvoke1 m_invoke;
};
