...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_voice_join_conference(void);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_voice_leave_conference(void);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_voice_send_ussd(ql_voice_ussd_info_t *pt_ussd);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_voice_set_recv_ussd_cb(ql_voice_ussd_cb_f cb);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_voice_set_white_list_enable(uint8_t enable);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_voice_get_white_list_enable(uint8_t *enable_ptr);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_voice_set_white_list_add_num(char *num_ptr, int len);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_voice_set_white_list_del_num(char *num_ptr, int len);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_voice_set_white_list_del_all(void);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_voice_get_white_list_all(ql_voice_white_list_info_t *info_ptr);
