 ...
 * @return no value
 */
typedef void (*ql_sim_card_refresh_cb_f)(ql_sim_refresh_info_t* p_info);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_sim_set_card_refresh_cb(ql_sim_card_refresh_cb_f cb);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_sim_get_eid(QL_SIM_SLOT_E slot, char *eid, int eid_len);
