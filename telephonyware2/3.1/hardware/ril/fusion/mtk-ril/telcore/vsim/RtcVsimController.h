...
#ifndef __RTC_VSIM_CONTROLLER_H__
#define __RTC_VSIM_CONTROLLER_H__
...
class RtcVsimController : public RfxController {
RFX_DECLARE_CLASS(RtcVsimController);

public:
    RtcVsimController();
    virtual ~RtcVsimController();
...
#endif /* __RTC_VSIM_CONTROLLER_H__ */
