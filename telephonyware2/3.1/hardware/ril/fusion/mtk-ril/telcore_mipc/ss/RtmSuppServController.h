 ...
 * Class RfxController
 *****************************************************************************/
class RtmSuppServController : public RfxController {
    // Required: declare this class
    RFX_DECLARE_CLASS(RtmSuppServController);

public:
    RtmSuppServController();
    virtual ~RtmSuppServController();
...
private:
    ...
    // An USSDR is waiting response, ALPS07746190
    bool mUssrWaitResponse;
