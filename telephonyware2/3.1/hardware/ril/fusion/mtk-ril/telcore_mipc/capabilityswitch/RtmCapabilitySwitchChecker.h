...
#ifndef __RTM_CAPABILITY_SWITCH_CHECKER_H__
#define __RTM_CAPABILITY_SWITCH_CHECKER_H__
 ...
 *****************************************************************************/
class RtmCapabilitySwitchChecker : public RfxController {
    // Required: declare this class
    RFX_DECLARE_CLASS(RtmCapabilitySwitchChecker);

  public:
    RtmCapabilitySwitchChecker();
    virtual ~RtmCapabilitySwitchChecker();
  ...
  private:
    ...
    int getSimOnOffState(int slot_id, bool log);
    bool isForceSimSwitch();
...
#endif /* __RTM_CAPABILITY_SWITCH_CHECKER_H__ */
