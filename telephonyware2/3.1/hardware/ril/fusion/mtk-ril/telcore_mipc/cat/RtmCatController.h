...
class RtmCatController : public RfxController {
    // Required: declare this class
    RFX_DECLARE_CLASS(RtmCatController);

public:
    RtmCatController();
    virtual ~RtmCatController();
...
private:
    ...
    void onSimOnOffStateChanged(RfxStatusKeyEnum key, RfxVariant old_value, RfxVariant value);
