...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_dm_set_modem_offline_reason_ind_cb(ql_dm_modem_offline_reason_ind_cb cb_func);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_dm_get_temperature_ex(int index, float *temperature);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_dm_get_radio_mode(int sim_id, QL_DM_RADIO_MODE_TYPE_E *p_info);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_dm_set_qoos_config(int sim_id, ql_dm_qoos_config_t config);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_dm_get_shutdown_reason(QL_DM_SHUTDOWN_REASON_E *shutdown_reason);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_dm_get_bootup_reason(QL_DM_BOOT_UP_REASON_E *bootup_reason);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_dm_set_modem_restart(void);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_dm_get_cpu_state(ql_dm_cpu_list_state_t *info);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_dm_set_cpu_state(int cpu_index, int enable);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_dm_poweroff(QL_DM_POWEROFF_MODE_E mode);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_dm_set_log_mask_clear(void);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_dm_get_period_log_enable(int *enable, int *log_time, int *interval_time);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_dm_set_period_log_enable(int enable, int log_time, int interval_time);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_dm_set_mbn_recovery_cb(ql_dm_mbn_recovery_cb_f cb);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_dm_get_active_antenna(QL_DM_ANTENNA_E *p_info);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_dm_switch_antenna(QL_DM_ANTENNA_E antenna);
