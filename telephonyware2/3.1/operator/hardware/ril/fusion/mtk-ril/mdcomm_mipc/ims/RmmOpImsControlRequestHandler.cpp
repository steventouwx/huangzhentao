...
#include "RmmOpImsControlRequestHandler.h"
#include "RmmOpImsControlInterface.h"

#define RFX_LOG_TAG "RmmOpImsControl"

 // register handler to channel
RFX_IMPLEMENT_OP_HANDLER_CLASS(RmmOpImsControlRequestHandler, RIL_CMD_PROXY_1);
...
RmmOpImsControlRequestHandler::RmmOpImsControlRequestHandler(
...
void RmmOpImsControlRequestHandler::onHandleTimer() {
}

void RmmOpImsControlRequestHandler::onHandleRequest(const sp<RfxMclMessage>& msg) {
...
void RmmOpImsControlRequestHandler::switchRcsRoiStatus(const sp<RfxMclMessage>& msg) {
...
void RmmOpImsControlRequestHandler::updateRcsCapabilities(const sp<RfxMclMessage>& msg) {
...
void RmmOpImsControlRequestHandler::updateRcsSessionInfo(const sp<RfxMclMessage>& msg) {
