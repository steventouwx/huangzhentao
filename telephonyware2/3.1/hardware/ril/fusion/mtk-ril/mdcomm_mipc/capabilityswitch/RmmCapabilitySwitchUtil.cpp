...
/*****************************************************************************
 * Class RmmCapabilitySwitchUtil
 *****************************************************************************/

int RmmCapabilitySwitchUtil::getMaxRadioGeneration(int radio_capability) {
...
int RmmCapabilitySwitchUtil::getMajorSim() {
    return RfxRilUtils::getMajorSim();
}

int RmmCapabilitySwitchUtil::isDisableCapabilitySwitch() {
    char tmp[RFX_PROPERTY_VALUE_MAX] = { 0 };
    rfx_property_get("ro.vendor.mtk_disable_cap_switch", tmp, "0");
    return atoi(tmp);
}

int RmmCapabilitySwitchUtil::getAdjustedRaf(int raf) {
...
bool RmmCapabilitySwitchUtil::isMessageBeforeCapabilitySwitch(const sp<RfxMclMessage> &msg) {
...
bool RmmCapabilitySwitchUtil::isDssNoResetSupport() {
    char tmp[RFX_PROPERTY_VALUE_MAX] = { 0 };
...
bool RmmCapabilitySwitchUtil::isDisableC2kCapability() {
    char tmp[RFX_PROPERTY_VALUE_MAX] = { 0 };
