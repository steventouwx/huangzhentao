...
#include "ql_type.h"
#include "ql_nw_common.h"

#define QL_MS_NW_DDS_TEMP_REASON_DSDA_IMPOSSIBLE           ((uint64_t)1)
#define QL_MS_NW_DDS_TEMP_REASON_DDS_INTERNET_UNAVAIL      ((uint64_t)1 << 1)
#define QL_MS_NW_DDS_TEMP_REASON_TX_SHARING                ((uint64_t)1 << 2)
#define QL_MS_NW_DDS_TEMP_REASON_BETTER_ACCESS_AVAIL       ((uint64_t)1 << 3)
#define QL_MS_NW_DDS_TEMP_REASON_CALL_STATUS_CHANGED       ((uint64_t)1 << 4)
#define QL_MS_NW_DDS_TEMP_REASON_ACTIVE_CALL_ON_DDS        ((uint64_t)1 << 5)
#define QL_MS_NW_DDS_TEMP_REASON_TEMP_SWITCH_DISABLED      ((uint64_t)1 << 6)
#define QL_MS_NW_DDS_TEMP_REASON_TEMP_DDS_REC_DISABLED     ((uint64_t)1 << 7)
#define QL_MS_NW_DDS_TEMP_REASON_NON_DDS_INTERNET_UNAVAIL  ((uint64_t)1 << 8)
#define QL_MS_NW_DDS_TEMP_REASON_DATA_OFF                  ((uint64_t)1 << 9)
#define QL_MS_NW_DDS_TEMP_REASON_CONDITION_NOT_MET         ((uint64_t)1 << 10)
#define QL_MS_NW_DDS_TEMP_REASON_EMERGENCY_CALL_ON_GOING   ((uint64_t)1 << 11)

#define QL_MS_NW_DDS_PERM_REASON_TEMP_CLEAN_UP            ((uint64_t)1)
#define QL_MS_NW_DDS_PERM_REASON_DATA_SETTING_OFF         ((uint64_t)1 << 1)
#define QL_MS_NW_DDS_PERM_REASON_PS_INVALID               ((uint64_t)1 << 2)
#define QL_MS_NW_DDS_PERM_REASON_INTERNET_NOT_AVAIL       ((uint64_t)1 << 3)
#define QL_MS_NW_DDS_PERM_REASON_DUAL_DATA_DSDS_SUBMODE   ((uint64_t)1 << 4)
#define QL_MS_NW_DDS_PERM_REASON_DUAL_DATA_IRAT_INIT      ((uint64_t)1 << 5)
#define QL_MS_NW_DDS_PERM_REASON_DUAL_DATA_TX_SHARING     ((uint64_t)1 << 6)

typedef enum {
  QL_MS_NW_MSIM_TYPE_DSDA = 0,
  QL_MS_NW_MSIM_TYPE_DSDS = 1,
  QL_MS_NW_MSIM_TYPE_UNKNOWN = 2
}QL_MS_NW_MSIM_TYPE_E;

typedef enum {
  QL_MS_NW_MSIM_TX_FULL_CONCURRENCY = 0,
  QL_MS_NW_MSIM_TX_SHARING = 1,
  QL_MS_NW_MSIM_TX_UNKNOWN = 2
}QL_MS_NW_MSIM_TX_TYPE_E;

typedef enum {
  QL_MS_NW_MSIM_OP_SUBSTATE_DSDS = 0,
  QL_MS_NW_MSIM_OP_SUBSTATE_DSDA = 1,
  QL_MS_NW_MSIM_OP_SUBSTATE_UNKNOWN = 2
}QL_MS_NW_MSIM_OP_SUBSTATE_E;

typedef enum {
  QL_MS_NW_MSIM_SUB_MODE_DSDS = 0,
  QL_MS_NW_MSIM_SUB_MODE_DSDA = 1,
  QL_MS_NW_MSIM_SUB_MODE_UNKNOWN = 2
}QL_MS_NW_MSIM_SUB_MODE_E;

typedef enum {
  QL_MS_NW_DDS_PRIMARY_SUBS = 1,
  QL_MS_NW_DDS_SECONDARY_SUBS = 2,
  QL_MS_NW_DDS_TERTIARY_SUBS = 3,
  QL_MS_NW_DDS_UNKNOWN_SUB = 4
}QL_MS_NW_DDS_SUB_E;

typedef enum {
  QL_MS_NW_DDS_RECOMMEND_SOURCE_UNSPECIFIED = 0,
  QL_MS_NW_DDS_RECOMMEND_SOURCE_ABSS = 1,
  QL_MS_NW_DDS_RECOMMEND_SOURCE_ABA = 2
}QL_MS_NW_DDS_RECOMMEND_SOURCE_E;

typedef enum {
  QL_MS_NW_DDS_SWITCH_PERMANENT = 0,
  QL_MS_NW_DDS_SWITCH_TEMPORARY = 1
}QL_MS_NW_DDS_SWITCH_TYPE_E;

typedef enum {
  QL_MS_NW_DDS_TEMP_RECOMMEND_LEVEL_REVOKE = 1,
  QL_MS_NW_DDS_TEMP_RECOMMEND_LEVEL_LOW = 2,
  QL_MS_NW_DDS_TEMP_RECOMMEND_LEVEL_HIGH = 3
}QL_MS_NW_DDS_TEMP_RECOMMEND_LEVEL_E;

typedef enum {
  QL_MS_NW_DDS_DYNAMIC_SWITCH_OFF = 0,
  QL_MS_NW_DDS_DYNAMIC_SWTICH_ON = 1,
  QL_MS_NW_DDS_DYNAMIC_SWITCH_RECOMMENDATION = 2
}QL_MS_NW_DDS_DYNAMIC_SWITCHS_E;

typedef enum {
  QL_MS_NW_DDS_DYNAMIC_RECOMMENDATION_THROUGHPUT_BASED = 1,
  QL_MS_NW_DDS_DYNAMIC_RECOMMENDATION_LATENCY_BASED = 2
}QL_MS_NW_DDS_DYNAMIC_RECOMMENDATION_TYPE_E;

typedef enum {
  QL_MS_NW_DDS_DYNAMIC_RECOMMENDATION_START = 1,
  QL_MS_NW_DDS_DYNAMIC_RECOMMENDATION_STOP = 2
}QL_MS_NW_DDS_DYNAMIC_RECOMMENDATION_ACTION_E;

typedef enum {
  QL_MS_NW_DDS_SWITCH_ALLOWED = 0x00,
  QL_MS_NW_DDS_SWITCH_NOT_ALLOWED = 0x01,
  QL_MS_NW_DDS_SWITCH_FAILED = 0x02,
}QL_MS_NW_DDS_SWITCH_RESULT_E;

typedef struct
{
  uint8_t msim_sub_mode_valid;
  QL_MS_NW_MSIM_SUB_MODE_E msim_sub_mode;
  
  uint8_t msim_tx_type_valid;    
  QL_MS_NW_MSIM_TX_TYPE_E msim_tx_type;
  
  uint8_t op_substate_valid;
  QL_MS_NW_MSIM_OP_SUBSTATE_E op_substate;
}ql_ms_nw_msim_status_t;


typedef struct
{
  QL_MS_NW_DDS_SUB_E dds_sub;

  uint8_t source_valid;
  QL_MS_NW_DDS_RECOMMEND_SOURCE_E dds_source;

  uint8_t switch_type_valid; 
  QL_MS_NW_DDS_SWITCH_TYPE_E switch_type;
}ql_ms_nw_dds_switch_info_t;
...
typedef void (*ql_ms_nw_ims_reg_status_ind_cb)(int sim_id, uint8_t ims_reg_status);

typedef void (*ql_ms_nw_rf_band_info_ind_cb)(int sim_id, QL_NW_BAND_INFO_E rf_band);

typedef void (*ql_ms_nw_lte_rach_fail_ind_cb)(int sim_id, ql_nw_lte_rach_fail_info_t *p_info);

typedef void (*ql_ms_nw_msim_status_ind_cb)(ql_ms_nw_msim_status_t* p_info);

typedef void (*ql_ms_nw_dds_switch_ind_cb)(QL_MS_NW_DDS_SWITCH_RESULT_E* dds_switch_result);

typedef void (*ql_ms_nw_dds_status_ind_cb)(ql_ms_nw_dds_status_info_t* dds_status_info);
...
/** 
  ...
  @param[in] sim id number
  @param[out] lower_mode, defined by QL_NW_LOWER_POWER_MASK_XXX
  @return Whether to successfully set the power mode
  @retval QL_ERR_OK successful
  @retval QL_ERR_NOT_INIT uninitialized
  @retval QL_ERR_SERVICE_NOT_READY service is not ready
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_get_power_mode(int sim_id, uint8_t *lower_mode);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_set_lte_rach_fail_ind_cb(int sim_id, ql_ms_nw_lte_rach_fail_ind_cb cb_func);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_get_high_cap_sub(int *sim_id);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_set_high_cap_sub(int sim_id);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_disable_nr5g(int sim_id, uint16_t opt_mask);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_get_ims_config(int sim_id, uint8_t* ims_enable_ptr);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_set_ims_config(int sim_id, uint8_t ims_enable);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_get_ims_config_ex(int sim_id, ql_nw_ims_config_ex_t* ims_config_ptr);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_set_ims_config_ex(int sim_id, ql_nw_ims_config_ex_t ims_config);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_get_ims_reg_status(int sim_id, uint8_t* ims_reg_status_ptr);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_set_ims_reg_status_ind_cb(int sim_id, ql_ms_nw_ims_reg_status_ind_cb cb_func);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_set_rf_band_info_ind_cb(int sim_id, ql_ms_nw_rf_band_info_ind_cb cb_func);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_set_dlm_4rx_enable(int sim_id, uint8_t dlm_4rx_enable);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_get_endc_config(int sim_id, ql_nw_get_endc_config_t* get_endc_config_ptr);
...
/** 
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_set_endc_config(int sim_id, ql_nw_set_endc_config_t set_endc_config);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_set_deprioritize_nr5g_enable(int sim_id, uint8_t deprioritize_nr5g_enable);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_trigger_wwan_reset(int sim_id);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_get_drx(int sim_id, ql_nw_get_drx_t * get_drx_ptr);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_set_drx(int sim_id, ql_nw_set_drx_t set_drx);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_get_negotiated_drx(int sim_id, ql_nw_get_negotiated_drx_t * get_negotiated_drx_ptr);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_set_pref_msim_type(QL_MS_NW_MSIM_TYPE_E msim_type);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_get_msim_status(ql_ms_nw_msim_status_t* p_status);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_set_msim_status_ind_cb(ql_ms_nw_msim_status_ind_cb cb_func);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_switch_dds(ql_ms_nw_dds_switch_info_t t_info);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_set_dds_switch_ind_cb(ql_ms_nw_dds_switch_ind_cb cb_func);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_get_dds_status(ql_ms_nw_dds_status_info_t* p_status);
...
/**
  ...
  */
/*-----------------------------------------------------------------------------------------------*/
int ql_ms_nw_set_dds_status_ind_cb(ql_ms_nw_dds_status_ind_cb cb_func);
